      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI03955'.
      ...
      * Called module names
       ...
       01  MOD-ZBI08250              PIC X(8) VALUE 'ZBI08250'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI08250-002.
               CALL 'ZBI08250' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI08250 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-003.
