      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI04236'.
      ...
      * Called module names
       ...
       01  MOD-ZBI06886              PIC X(8) VALUE 'ZBI06886'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI06886-002.
               CALL 'ZBI06886' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI06886 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-003.
