      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI04796'.
      ...
      * Called module names
       ...
       01  MOD-ZBI07486              PIC X(8) VALUE 'ZBI07486'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI08156-001.
               PERFORM CALL-ZBI07486-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI07486-002.
               CALL 'ZBI07486' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI07486 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-003.
