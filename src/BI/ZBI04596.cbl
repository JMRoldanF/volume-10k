      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI04596'.
      ...
      * Called module names
       01  MOD-ZBI08406              PIC X(8) VALUE 'ZBI08406'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI07786-001.
               PERFORM CALL-ZBI08406-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI08406-002.
               CALL 'ZBI08406' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
