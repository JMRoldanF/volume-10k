      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI03788'.
      ...
      * Called module names
       01  MOD-ZBI07772              PIC X(8) VALUE 'ZBI07772'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI07772-001.
               CALL 'ZBI07772' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI07772 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI06586-002.
