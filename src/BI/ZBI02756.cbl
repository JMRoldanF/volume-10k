      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI02756'.
      ...
      * Called module names
       01  MOD-ZBI04236              PIC X(8) VALUE 'ZBI04236'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI03316-001.
               PERFORM CALL-ZBI04236-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI03316-001.
               MOVE 'ZBI03316' TO WS-PROGNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZBI04236-002.
               EXEC CICS LINK PROGRAM('ZBI04236')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI04236 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-003.
