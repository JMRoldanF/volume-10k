      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI03846'.
      ...
      * Called module names
       ...
       01  MOD-ZCU08164              PIC X(8) VALUE 'ZCU08164'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI06456-001.
               PERFORM CALL-ZCU08164-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU08164-002.
               CALL 'ZCU08164' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU08164 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-EXCESS-0001.
