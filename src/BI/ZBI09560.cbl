      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI09560'.
      ...
      * Called module names
       01  MOD-ZBI07156              PIC X(8) VALUE 'ZBI07156'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU06334-002.
               PERFORM CALL-ZBI07086-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI07156-001.
               CALL 'ZBI07156' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI07156 FAILED' TO EM-VARIABLE
