      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI03086'.
      ...
      * Called module names
       01  MOD-ZCU06614              PIC X(8) VALUE 'ZCU06614'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU06614-001.
               PERFORM CALL-ZBI08556-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU06614-001.
               CALL 'ZCU06614' USING DFHCOMMAREA
                         WS-STATUS-CODE.
