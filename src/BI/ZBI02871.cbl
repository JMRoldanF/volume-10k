      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI02871'.
      ...
      * Called module names
       01  MOD-ZBI07463              PIC X(8) VALUE 'ZBI07463'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI07463-001.
               PERFORM CALL-ZBI08513-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI07463-001.
               CALL 'ZBI07463' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI07463 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI08513-002.
