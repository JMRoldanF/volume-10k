      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI05186'.
      ...
      * Called module names
       01  MOD-ZBI06856              PIC X(8) VALUE 'ZBI06856'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI06856-001.
               CALL 'ZBI06856' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI06856 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
