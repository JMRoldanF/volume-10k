      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI03006'.
      ...
      * Called module names
       ...
       01  MOD-ZBI07816              PIC X(8) VALUE 'ZBI07816'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI08106-001.
               PERFORM CALL-ZBI07816-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI07816-002.
               CALL 'ZBI07816' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI07816 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-003.
