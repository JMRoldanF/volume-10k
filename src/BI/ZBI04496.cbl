      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI04496'.
      ...
      * Called module names
       01  MOD-ZBI06346              PIC X(8) VALUE 'ZBI06346'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI06346-001.
               CALL 'ZBI06346' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI06346 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-MODEL-0001.
