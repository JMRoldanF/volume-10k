      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI05400'.
      ...
      * Called module names
       ...
       01  MOD-ZBI07374              PIC X(8) VALUE 'ZBI07374'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI07077-001.
               PERFORM CALL-ZBI07374-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI07374-002.
               CALL 'ZBI07374' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI07374 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-003.
