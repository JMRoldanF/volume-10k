      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00353'.
      ...
      * Called module names
       01  MOD-ZBI01169              PIC X(8) VALUE 'ZBI01169'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01169-001.
               PERFORM CALL-ZBI01512-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01169-001.
               EXEC CICS LINK PROGRAM('ZBI01169')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01169 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01512-002.
