      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI03381'.
      ...
      * Called module names
       01  MOD-ZBI07688              PIC X(8) VALUE 'ZBI07688'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI07688-001.
               CALL 'ZBI07688' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI07688 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI07709-002.
               MOVE 'ZBI07709' TO WS-SUBNAME-5
