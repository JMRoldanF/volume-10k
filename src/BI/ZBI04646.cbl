      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI04646'.
      ...
      * Called module names
       01  MOD-ZBI07116              PIC X(8) VALUE 'ZBI07116'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI07116-001.
               CALL 'ZBI07116' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI07116 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI07086-002.
