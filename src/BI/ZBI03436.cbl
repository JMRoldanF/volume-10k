      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI03436'.
      ...
      * Called module names
       01  MOD-ZBI06976              PIC X(8) VALUE 'ZBI06976'.
       01  MOD-ZBI07556              PIC X(8) VALUE 'ZBI07556'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI06976-001.
               PERFORM CALL-ZBI07556-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI06976-001.
               CALL 'ZBI06976' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI07556-002.
               CALL 'ZBI07556' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI07556 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-003.
