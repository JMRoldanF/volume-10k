      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI09690'.
      ...
      * Called module names
       01  MOD-ZBI06846              PIC X(8) VALUE 'ZBI06846'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI06546-002.
               PERFORM CALL-ZBI06846-003.
               PERFORM CALL-ZBI07636-004.
               PERFORM CALL-ZBI07906-005.
               PERFORM CALL-ZMT07971-006.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI06846-003.
               CALL 'ZBI06846' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI06846 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI07636-004.
