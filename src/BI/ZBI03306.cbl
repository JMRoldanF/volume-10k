      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI03306'.
      ...
      * Called module names
       ...
       01  MOD-ZBI08126              PIC X(8) VALUE 'ZBI08126'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI08126-002.
               CALL 'ZBI08126' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI08126 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-003.
