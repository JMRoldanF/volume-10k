      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI05526'.
      ...
      * Called module names
       01  MOD-ZBI06376              PIC X(8) VALUE 'ZBI06376'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI08646-002.
               PERFORM CALL-ZCU09998-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZBI06376-001.
               CALL 'ZBI06376' USING DFHCOMMAREA
                         WS-STATUS-CODE.
