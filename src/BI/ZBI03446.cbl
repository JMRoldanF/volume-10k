      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI03446'.
      ...
      * Called module names
       01  MOD-ZBI06436              PIC X(8) VALUE 'ZBI06436'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI06436-001.
               CALL 'ZBI06436' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI06436 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MAKE-0001.
