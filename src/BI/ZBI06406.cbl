      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI06406'.
      ...
      * Called module names
       01  MOD-ZBI08526              PIC X(8) VALUE 'ZBI08526'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI08526-001.
               CALL 'ZBI08526' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI08526 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-002.
