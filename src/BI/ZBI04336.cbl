      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI04336'.
      ...
      * Called module names
       01  MOD-ZBI06646              PIC X(8) VALUE 'ZBI06646'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI06646-001.
               CALL 'ZBI06646' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI06646 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI07256-002.
