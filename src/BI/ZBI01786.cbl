      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI01786'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI04341-001.
               EXEC CICS LINK PROGRAM('ZBI04341')
      ...
      *----------------------------------------------------------------*
       CALL-ZBI05822-002.
               MOVE 'ZBI05822' TO WS-PROGNAME-6
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI05822 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI06789-003.
