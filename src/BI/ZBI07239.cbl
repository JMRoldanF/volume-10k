      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI07239'.
      ...
      * Called module names
       01  MOD-ZBI06897              PIC X(8) VALUE 'ZBI06897'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI06897-001.
               CALL 'ZBI06897' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI06897 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-002.
