      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI03036'.
      ...
      * Called module names
       01  MOD-ZBI08586              PIC X(8) VALUE 'ZBI08586'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI08586-001.
               CALL 'ZBI08586' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI08586 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
