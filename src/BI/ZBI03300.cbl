      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI03300'.
      ...
      * Called module names
       01  MOD-ZBI07073              PIC X(8) VALUE 'ZBI07073'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI07073-001.
               CALL 'ZBI07073' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI07073 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
