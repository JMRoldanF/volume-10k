      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG04644'.
      ...
      * Called module names
       01  MOD-ZAG07469              PIC X(8) VALUE 'ZAG07469'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG07469-002.
               CALL 'ZAG07469' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG07469 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-VALUE-0001.
