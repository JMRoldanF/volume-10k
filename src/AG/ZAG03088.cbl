      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG03088'.
      ...
      * Called module names
       01  MOD-ZAG07958              PIC X(8) VALUE 'ZAG07958'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG07958-001.
               CALL 'ZAG07958' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG07958 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
