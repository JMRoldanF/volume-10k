      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG02706'.
      ...
      * Called module names
       ...
       01  MOD-ZAG04195              PIC X(8) VALUE 'ZAG04195'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG03077-001.
               PERFORM CALL-ZAG04195-002.
               PERFORM CALL-ZEN05749-003.
               PERFORM CALL-ZAG06355-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG03077-001.
               EXEC CICS LINK PROGRAM('ZAG03077')
      ...
      *----------------------------------------------------------------*
       CALL-ZAG04195-002.
               EXEC CICS LINK PROGRAM('ZAG04195')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG04195 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN05749-003.
               MOVE 'ZEN05749' TO WS-PROGNAME-1
