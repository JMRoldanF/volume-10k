      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00838'.
      ...
      * Called module names
       ...
       01  MOD-ZAG08328              PIC X(8) VALUE 'ZAG08328'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO03002-001.
               PERFORM CALL-ZAG08328-002.
               PERFORM CALL-ZAG08458-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG08328-002.
               CALL 'ZAG08328' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
