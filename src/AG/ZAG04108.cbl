      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG04108'.
      ...
      * Called module names
       ...
       01  MOD-ZAG06668              PIC X(8) VALUE 'ZAG06668'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG06668-002.
               CALL 'ZAG06668' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG06668 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-003.
