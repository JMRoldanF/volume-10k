      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG02818'.
      ...
      * Called module names
       01  MOD-ZAG08008              PIC X(8) VALUE 'ZAG08008'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG08008-001.
               CALL 'ZAG08008' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG08008 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG06668-002.
