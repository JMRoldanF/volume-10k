      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01218'.
      ...
      * Called module names
       01  MOD-ZBI03156              PIC X(8) VALUE 'ZBI03156'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI03156-001.
               EXEC CICS LINK PROGRAM('ZBI03156')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI03156 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-002.
