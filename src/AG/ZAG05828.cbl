      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG05828'.
      ...
      * Called module names
       01  MOD-ZAG08338              PIC X(8) VALUE 'ZAG08338'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG08338-001.
               CALL 'ZAG08338' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG08338 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
