      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG04138'.
      ...
      * Called module names
       ...
       01  MOD-ZAG06950              PIC X(8) VALUE 'ZAG06950'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG06544-001.
               PERFORM CALL-ZAG06950-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG06950-002.
               CALL 'ZAG06950' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG06950 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
