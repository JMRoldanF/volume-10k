      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00770'.
      ...
      * Called module names
       01  MOD-ZAG02719              PIC X(8) VALUE 'ZAG02719'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG02496-001.
               PERFORM CALL-ZAG02719-002.
               PERFORM CALL-ZAG02678-003.
               PERFORM CALL-ZMT09995-004.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAG02496-001.
               MOVE 'ZAG02496' TO WS-PROGNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZAG02719-002.
               EXEC CICS LINK PROGRAM('ZAG02719')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG02719 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG02678-003.
