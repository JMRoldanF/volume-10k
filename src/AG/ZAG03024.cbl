      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG03024'.
      ...
      * Called module names
       ...
       01  MOD-ZAG07846              PIC X(8) VALUE 'ZAG07846'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG06969-001.
               PERFORM CALL-ZAG07846-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG07846-002.
               CALL 'ZAG07846' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
