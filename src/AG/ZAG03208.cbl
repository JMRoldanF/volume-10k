      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG03208'.
      ...
      * Called module names
       01  MOD-ZAG08208              PIC X(8) VALUE 'ZAG08208'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG08208-001.
               CALL 'ZAG08208' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG08208 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
