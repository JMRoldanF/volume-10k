      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG03147'.
      ...
      * Called module names
       01  MOD-ZAG07595              PIC X(8) VALUE 'ZAG07595'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG07595-001.
               CALL 'ZAG07595' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG07595 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG07004-002.
               MOVE 'ZAG07004' TO WS-SUBNAME-7
