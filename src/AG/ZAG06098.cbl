      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG06098'.
      ...
      * Called module names
       ...
       01  MOD-ZAG06538              PIC X(8) VALUE 'ZAG06538'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG08578-001.
               PERFORM CALL-ZAG06538-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG06538-002.
               CALL 'ZAG06538' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG06538 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-003.
