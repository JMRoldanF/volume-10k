      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG03808'.
      ...
      * Called module names
       01  MOD-ZAG07908              PIC X(8) VALUE 'ZAG07908'.
       01  MOD-ZHO08492              PIC X(8) VALUE 'ZHO08492'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG07908-001.
               PERFORM CALL-ZHO08492-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG07908-001.
               CALL 'ZAG07908' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG07908 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO08492-002.
               CALL 'ZHO08492' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO08492 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-003.
