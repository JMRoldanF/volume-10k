      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG09532'.
      ...
      * Called module names
       ...
       01  MOD-ZAG07088              PIC X(8) VALUE 'ZAG07088'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG06998-002.
               PERFORM CALL-ZAG07808-003.
               PERFORM CALL-ZAG07168-004.
               PERFORM CALL-ZAG07088-005.
               PERFORM CALL-ZAG06658-006.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG07088-005.
               CALL 'ZAG07088' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG07088 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG06658-006.
