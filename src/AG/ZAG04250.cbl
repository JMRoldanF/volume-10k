      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG04250'.
      ...
      * Called module names
       ...
       01  MOD-ZCL07092              PIC X(8) VALUE 'ZCL07092'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL07092-002.
               CALL 'ZCL07092' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL07092 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-003.
