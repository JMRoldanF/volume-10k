      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG04048'.
      ...
      * Called module names
       ...
       01  MOD-ZAG08288              PIC X(8) VALUE 'ZAG08288'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG06438-001.
               PERFORM CALL-ZAG08288-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG08288-002.
               CALL 'ZAG08288' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
