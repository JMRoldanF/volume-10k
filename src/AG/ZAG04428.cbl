      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG04428'.
      ...
      * Called module names
       01  MOD-ZAG06328              PIC X(8) VALUE 'ZAG06328'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG06328-001.
               CALL 'ZAG06328' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG06328 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-002.
