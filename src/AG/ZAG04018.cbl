      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG04018'.
      ...
      * Called module names
       ...
       01  MOD-ZAG08378              PIC X(8) VALUE 'ZAG08378'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG08378-002.
               CALL 'ZAG08378' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG08378 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
