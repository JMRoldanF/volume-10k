      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG04249'.
      ...
      * Called module names
       01  MOD-ZAG07961              PIC X(8) VALUE 'ZAG07961'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG07961-002.
               CALL 'ZAG07961' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG07961 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-003.
