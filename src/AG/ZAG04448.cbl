      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG04448'.
      ...
      * Called module names
       ...
       01  MOD-ZAG06988              PIC X(8) VALUE 'ZAG06988'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG08388-001.
               PERFORM CALL-ZAG06988-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG06988-002.
               CALL 'ZAG06988' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG06988 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-003.
