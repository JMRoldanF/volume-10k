      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG04328'.
      ...
      * Called module names
       01  MOD-ZAG06968              PIC X(8) VALUE 'ZAG06968'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG06968-001.
               CALL 'ZAG06968' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG06968 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
