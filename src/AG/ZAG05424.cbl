      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG05424'.
      ...
      * Called module names
       01  MOD-ZAG07240              PIC X(8) VALUE 'ZAG07240'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG07240-001.
               CALL 'ZAG07240' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG07240 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG07989-002.
