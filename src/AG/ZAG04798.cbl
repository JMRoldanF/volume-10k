      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG04798'.
      ...
      * Called module names
       ...
       01  MOD-ZBI06336              PIC X(8) VALUE 'ZBI06336'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG08028-001.
               PERFORM CALL-ZBI06336-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI06336-002.
               CALL 'ZBI06336' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI06336 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
