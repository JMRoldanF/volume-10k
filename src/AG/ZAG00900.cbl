      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00900'.
      ...
      * Called module names
       01  MOD-ZAG03472              PIC X(8) VALUE 'ZAG03472'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG03472-001.
               EXEC CICS LINK PROGRAM('ZAG03472')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG03472 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG04414-002.
