      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG09642'.
      ...
      * Called module names
       ...
       01  MOD-ZHO07902              PIC X(8) VALUE 'ZHO07902'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG07118-001.
               PERFORM CALL-ZHO07902-002.
               PERFORM CALL-ZAG03738-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO07902-002.
               CALL 'ZHO07902' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO07902 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG03738-003.
               MOVE 'ZAG03738' TO WS-SUBNAME-2
