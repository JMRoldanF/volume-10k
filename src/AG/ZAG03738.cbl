      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG03738'.
      ...
      * Called module names
       01  MOD-ZAG08418              PIC X(8) VALUE 'ZAG08418'.
       01  MOD-ZAG07288              PIC X(8) VALUE 'ZAG07288'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG08418-001.
               PERFORM CALL-ZAG07288-002.
               PERFORM CALL-ZHO09996-003.
               PERFORM EXPAND-VALUE-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAG08418-001.
               CALL 'ZAG08418' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG07288-002.
               CALL 'ZAG07288' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG07288 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-003.
