      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG09608'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG07054-002.
               PERFORM CALL-ZAG07859-003.
               PERFORM CALL-ZAG07146-004.
               PERFORM CALL-ZAG04694-005.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG04694-005.
               CALL 'ZAG04694' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
