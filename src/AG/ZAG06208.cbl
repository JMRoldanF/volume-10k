      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG06208'.
      ...
      * Called module names
       01  MOD-ZAG06498              PIC X(8) VALUE 'ZAG06498'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG06498-001.
               PERFORM CALL-ZAG06958-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG06498-001.
               CALL 'ZAG06498' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG06498 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG06958-002.
