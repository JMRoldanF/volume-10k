      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO02998'.
      ...
      * Called module names
       ...
       01  MOD-ZHO07603              PIC X(8) VALUE 'ZHO07603'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN08505-001.
               PERFORM CALL-ZHO07603-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO07603-002.
               CALL 'ZHO07603' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO07603 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-003.
