      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04408'.
      ...
      * Called module names
       ...
       01  MOD-ZHO07879              PIC X(8) VALUE 'ZHO07879'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO07879-002.
               CALL 'ZHO07879' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO07879 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
