      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04222'.
      ...
      * Called module names
       01  MOD-ZCL07055              PIC X(8) VALUE 'ZCL07055'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL07055-001.
               CALL 'ZCL07055' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL07055 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-002.
