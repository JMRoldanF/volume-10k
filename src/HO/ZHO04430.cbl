      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04430'.
      ...
      * Called module names
       ...
       01  MOD-ZHO07845              PIC X(8) VALUE 'ZHO07845'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO07845-002.
               CALL 'ZHO07845' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
