      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO02854'.
      ...
      * Called module names
       01  MOD-ZCU08629              PIC X(8) VALUE 'ZCU08629'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU08629-001.
               PERFORM CALL-ZHO08672-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU08629-001.
               CALL 'ZCU08629' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU08629 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO08672-002.
