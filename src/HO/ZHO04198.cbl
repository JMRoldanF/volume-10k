      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04198'.
      ...
      * Called module names
       01  MOD-ZHO06425              PIC X(8) VALUE 'ZHO06425'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO06425-001.
               CALL 'ZHO06425' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO06425 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
