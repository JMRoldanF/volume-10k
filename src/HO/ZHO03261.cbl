      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO03261'.
      ...
      * Called module names
       ...
       01  MOD-ZHO08541              PIC X(8) VALUE 'ZHO08541'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO08541-002.
               CALL 'ZHO08541' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO08541 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-003.
