      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00592'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO02512-001.
               PERFORM CALL-ZHO01182-002.
               PERFORM CALL-ZCL00785-003.
               PERFORM CALL-ZEN09997-004.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZHO02512-001.
               MOVE 'ZHO02512' TO WS-PROGNAME-8
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO02512 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01182-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00785-003.
               EXEC CICS START TRANSID('Z0LT')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z0LT is defined against ZCL00785
               IF WS-RESP NOT = DFHRESP(NORMAL)
