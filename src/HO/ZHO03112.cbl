      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO03112'.
      ...
      * Called module names
       01  MOD-ZHO06602              PIC X(8) VALUE 'ZHO06602'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO06602-001.
               CALL 'ZHO06602' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO06602 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL06735-002.
