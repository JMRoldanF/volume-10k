      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO03448'.
      ...
      * Called module names
       01  MOD-ZHO08317              PIC X(8) VALUE 'ZHO08317'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO08317-001.
               CALL 'ZHO08317' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO08317 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO06621-002.
