      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO03512'.
      ...
      * Called module names
       ...
       01  MOD-ZHO07162              PIC X(8) VALUE 'ZHO07162'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO07162-002.
               CALL 'ZHO07162' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
