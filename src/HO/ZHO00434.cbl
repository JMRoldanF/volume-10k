      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00434'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01937-002.
               MOVE 'ZUW01937' TO WS-PROGNAME-3
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00570-003.
               EXEC CICS START TRANSID('Z0FU')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z0FU is defined against ZHO00570
               IF WS-RESP NOT = DFHRESP(NORMAL)
