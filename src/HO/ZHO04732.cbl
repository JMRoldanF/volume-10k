      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04732'.
      ...
      * Called module names
       ...
       01  MOD-ZCU07624              PIC X(8) VALUE 'ZCU07624'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN08033-001.
               PERFORM CALL-ZCU07624-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU07624-002.
               CALL 'ZCU07624' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU07624 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-003.
