      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO03818'.
      ...
      * Called module names
       ...
       01  MOD-ZHO06747              PIC X(8) VALUE 'ZHO06747'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO06747-002.
               CALL 'ZHO06747' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO06747 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
