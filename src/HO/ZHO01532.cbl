      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01532'.
      ...
      * Called module names
       01  MOD-ZHO03112              PIC X(8) VALUE 'ZHO03112'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI04016-001.
               PERFORM CALL-ZHO03112-002.
               PERFORM CALL-ZHO06262-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI04016-001.
               MOVE 'ZBI04016' TO WS-PROGNAME-8
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI04016 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO03112-002.
               EXEC CICS LINK PROGRAM('ZHO03112')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO03112 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO06262-003.
