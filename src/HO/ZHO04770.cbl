      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04770'.
      ...
      * Called module names
       01  MOD-ZHO06710              PIC X(8) VALUE 'ZHO06710'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO06710-001.
               PERFORM CALL-ZUW07400-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO06710-001.
               CALL 'ZHO06710' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO06710 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW07400-002.
