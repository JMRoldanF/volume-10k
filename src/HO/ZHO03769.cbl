      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO03769'.
      ...
      * Called module names
       01  MOD-ZUW06398              PIC X(8) VALUE 'ZUW06398'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW06398-001.
               CALL 'ZUW06398' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW06398 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-002.
