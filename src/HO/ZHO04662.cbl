      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04662'.
      ...
      * Called module names
       01  MOD-ZHO07892              PIC X(8) VALUE 'ZHO07892'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO07892-001.
               CALL 'ZHO07892' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO07892 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO08332-002.
