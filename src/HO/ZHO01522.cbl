      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01522'.
      ...
      * Called module names
       01  MOD-ZHO06272              PIC X(8) VALUE 'ZHO06272'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO04412-001.
               MOVE 'ZHO04412' TO WS-PROGNAME-2
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO04412 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO06272-002.
               EXEC CICS LINK PROGRAM('ZHO06272')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
