      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04329'.
      ...
      * Called module names
       01  MOD-ZCU06542              PIC X(8) VALUE 'ZCU06542'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW07274-001.
               PERFORM CALL-ZCU06542-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU06542-002.
               CALL 'ZCU06542' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU06542 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-003.
