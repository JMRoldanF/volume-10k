      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04672'.
      ...
      * Called module names
       01  MOD-ZHO06962              PIC X(8) VALUE 'ZHO06962'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO06962-001.
               CALL 'ZHO06962' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO06962 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
