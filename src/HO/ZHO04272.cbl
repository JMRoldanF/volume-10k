      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04272'.
      ...
      * Called module names
       01  MOD-ZHO08422              PIC X(8) VALUE 'ZHO08422'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO08422-001.
               PERFORM CALL-ZUW06640-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO08422-001.
               CALL 'ZHO08422' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO08422 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW06640-002.
