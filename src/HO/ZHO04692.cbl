      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04692'.
      ...
      * Called module names
       01  MOD-ZHO07002              PIC X(8) VALUE 'ZHO07002'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO07002-001.
               CALL 'ZHO07002' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO07002 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-002.
