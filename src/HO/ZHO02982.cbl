      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO02982'.
      ...
      * Called module names
       01  MOD-ZHO06472              PIC X(8) VALUE 'ZHO06472'.
       01  MOD-ZHO07122              PIC X(8) VALUE 'ZHO07122'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO06472-001.
               PERFORM CALL-ZHO07122-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO06472-001.
               CALL 'ZHO06472' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO07122-002.
               CALL 'ZHO07122' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO07122 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
