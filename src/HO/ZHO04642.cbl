      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04642'.
      ...
      * Called module names
       01  MOD-ZHO07512              PIC X(8) VALUE 'ZHO07512'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO07512-001.
               PERFORM CALL-ZHO07702-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZHO07512-001.
               CALL 'ZHO07512' USING DFHCOMMAREA
                         WS-STATUS-CODE.
