      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04714'.
      ...
      * Called module names
       01  MOD-ZHO08683              PIC X(8) VALUE 'ZHO08683'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO08683-001.
               CALL 'ZHO08683' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO08683 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-002.
