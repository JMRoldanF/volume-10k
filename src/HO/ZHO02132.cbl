      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO02132'.
      ...
      * Called module names
       ...
       01  MOD-ZHO02842              PIC X(8) VALUE 'ZHO02842'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO03142-001.
               PERFORM CALL-ZUW03070-002.
               PERFORM CALL-ZHO02842-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO02842-003.
               EXEC CICS LINK PROGRAM('ZHO02842')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO02842 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-004.
