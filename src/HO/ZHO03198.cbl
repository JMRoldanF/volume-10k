      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO03198'.
      ...
      * Called module names
       01  MOD-ZHO08148              PIC X(8) VALUE 'ZHO08148'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO08148-001.
               PERFORM CALL-ZHO07648-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO08148-001.
               CALL 'ZHO08148' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO08148 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO07648-002.
