      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO03682'.
      ...
      * Called module names
       01  MOD-ZHO06698              PIC X(8) VALUE 'ZHO06698'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO06698-001.
               CALL 'ZHO06698' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO06698 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO08672-002.
