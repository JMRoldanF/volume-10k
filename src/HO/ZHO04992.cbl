      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04992'.
      ...
      * Called module names
       ...
       01  MOD-ZHO07502              PIC X(8) VALUE 'ZHO07502'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO06332-001.
               PERFORM CALL-ZHO07502-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO07502-002.
               CALL 'ZHO07502' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
