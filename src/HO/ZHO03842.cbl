      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO03842'.
      ...
      * Called module names
       01  MOD-ZHO08202              PIC X(8) VALUE 'ZHO08202'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO08202-001.
               CALL 'ZHO08202' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO08202 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-COLOUR-0001.
