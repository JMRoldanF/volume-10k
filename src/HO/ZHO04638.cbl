      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04638'.
      ...
      * Called module names
       ...
       01  MOD-ZHO07883              PIC X(8) VALUE 'ZHO07883'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO07408-001.
               PERFORM CALL-ZHO07883-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO07883-002.
               CALL 'ZHO07883' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO07883 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-003.
