      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04912'.
      ...
      * Called module names
       01  MOD-ZHO08012              PIC X(8) VALUE 'ZHO08012'.
       01  MOD-ZHO07942              PIC X(8) VALUE 'ZHO07942'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO08012-001.
               PERFORM CALL-ZHO07942-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO08012-001.
               CALL 'ZHO08012' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO08012 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO07942-002.
               CALL 'ZHO07942' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO07942 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-003.
