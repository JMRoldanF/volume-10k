      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO03775'.
      ...
      * Called module names
       01  MOD-ZHO08000              PIC X(8) VALUE 'ZHO08000'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO08000-001.
               CALL 'ZHO08000' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO08000 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-002.
