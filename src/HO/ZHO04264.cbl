      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04264'.
      ...
      * Called module names
       01  MOD-ZHO08406              PIC X(8) VALUE 'ZHO08406'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO08406-001.
               CALL 'ZHO08406' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO08406 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-002.
