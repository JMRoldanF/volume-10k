      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00549'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01496              PIC X(8) VALUE 'ZHO01496'.
       01  MOD-ZHO00013              PIC X(8) VALUE 'ZHO00013'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01496-002.
               EXEC CICS LINK PROGRAM('ZHO01496')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01496 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO00013-003.
               EXEC CICS XCTL PROGRAM('ZHO00013')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00013 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-004.
