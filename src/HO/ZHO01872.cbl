      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01872'.
      ...
      * Called module names
       01  MOD-ZCU05614              PIC X(8) VALUE 'ZCU05614'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO03842-001.
               PERFORM CALL-ZCU05614-002.
               PERFORM CALL-ZHO07682-003.
               PERFORM CALL-ZHO06402-004.
               PERFORM CALL-ZHO09996-005.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZHO03842-001.
               MOVE 'ZHO03842' TO WS-PROGNAME-3
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO03842 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU05614-002.
               EXEC CICS LINK PROGRAM('ZCU05614')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
