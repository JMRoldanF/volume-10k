      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00572'.
      ...
      * Called module names
       01  MOD-ZMT01801              PIC X(8) VALUE 'ZMT01801'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01801-001.
               PERFORM CALL-ZHO01212-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01801-001.
               EXEC CICS LINK PROGRAM('ZMT01801')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01801 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01212-002.
               MOVE 'ZHO01212' TO WS-PROGNAME-7
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00036-003.
               EXEC CICS START TRANSID('Z010')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z010 is defined against ZBI00036
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00036 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-004.
