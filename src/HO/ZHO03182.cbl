      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO03182'.
      ...
      * Called module names
       01  MOD-ZHO07592              PIC X(8) VALUE 'ZHO07592'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO07592-001.
               PERFORM CALL-ZHO07372-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO07592-001.
               CALL 'ZHO07592' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO07592 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO07372-002.
               MOVE 'ZHO07372' TO WS-SUBNAME-6
