      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04267'.
      ...
      * Called module names
       ...
       01  MOD-ZHO07191              PIC X(8) VALUE 'ZHO07191'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO07191-002.
               CALL 'ZHO07191' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
