      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO02422'.
      ...
      * Called module names
       01  MOD-ZHO04931              PIC X(8) VALUE 'ZHO04931'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO04931-001.
               EXEC CICS LINK PROGRAM('ZHO04931')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO04931 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW06112-002.
