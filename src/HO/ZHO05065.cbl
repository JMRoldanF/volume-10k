      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO05065'.
      ...
      * Called module names
       ...
       01  MOD-ZHO07856              PIC X(8) VALUE 'ZHO07856'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO07856-002.
               CALL 'ZHO07856' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO07856 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-003.
