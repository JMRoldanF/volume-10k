      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO03232'.
      ...
      * Called module names
       01  MOD-ZHO08022              PIC X(8) VALUE 'ZHO08022'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO08022-001.
               CALL 'ZHO08022' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO08022 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-002.
