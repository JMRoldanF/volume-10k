      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO04424'.
      ...
      * Called module names
       01  MOD-ZHO07715              PIC X(8) VALUE 'ZHO07715'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO07715-002.
               CALL 'ZHO07715' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO07715 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-TERM-0001.
