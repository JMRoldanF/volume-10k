      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO05962'.
      ...
      * Called module names
       01  MOD-ZHO06882              PIC X(8) VALUE 'ZHO06882'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO06882-001.
               CALL 'ZHO06882' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO06882 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-002.
