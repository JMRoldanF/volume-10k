      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL03334'.
      ...
      * Called module names
       01  MOD-ZCL06993              PIC X(8) VALUE 'ZCL06993'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL06993-001.
               CALL 'ZCL06993' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL06993 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL06555-002.
               MOVE 'ZCL06555' TO WS-SUBNAME-2
