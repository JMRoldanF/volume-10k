      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL03235'.
      ...
      * Called module names
       01  MOD-ZCL08305              PIC X(8) VALUE 'ZCL08305'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL08305-001.
               CALL 'ZCL08305' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL08305 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
