      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL05525'.
      ...
      * Called module names
       01  MOD-ZCL07765              PIC X(8) VALUE 'ZCL07765'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL07765-001.
               PERFORM CALL-ZCL07645-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL07765-001.
               CALL 'ZCL07765' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL07765 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL07645-002.
