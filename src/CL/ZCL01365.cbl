      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01365'.
      ...
      * Called module names
       ...
       01  MOD-ZCL06285              PIC X(8) VALUE 'ZCL06285'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL06285-002.
               EXEC CICS LINK PROGRAM('ZCL06285')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL06285 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
