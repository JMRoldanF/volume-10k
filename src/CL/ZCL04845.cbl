      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL04845'.
      ...
      * Called module names
       ...
       01  MOD-ZCL08535              PIC X(8) VALUE 'ZCL08535'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL07505-001.
               PERFORM CALL-ZCL08535-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL08535-002.
               CALL 'ZCL08535' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL08535 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
