      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL03155'.
      ...
      * Called module names
       01  MOD-ZCL08255              PIC X(8) VALUE 'ZCL08255'.
       01  MOD-ZCU06484              PIC X(8) VALUE 'ZCU06484'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL08255-001.
               CALL 'ZCL08255' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL08255 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU06484-002.
               CALL 'ZCU06484' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU06484 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
