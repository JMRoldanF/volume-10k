      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL03575'.
      ...
      * Called module names
       01  MOD-ZCL06605              PIC X(8) VALUE 'ZCL06605'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL06605-001.
               PERFORM CALL-ZCL06455-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL06605-001.
               CALL 'ZCL06605' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL06605 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL06455-002.
