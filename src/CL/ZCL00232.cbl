      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00232'.
      ...
      * Called module names
       01  MOD-ZCL01717              PIC X(8) VALUE 'ZCL01717'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01717-001.
               PERFORM CALL-ZCL02782-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01717-001.
               EXEC CICS LINK PROGRAM('ZCL01717')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01717 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL02782-002.
