      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00865'.
      ...
      * Called module names
       01  MOD-ZHO03872              PIC X(8) VALUE 'ZHO03872'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO03872-001.
               EXEC CICS LINK PROGRAM('ZHO03872')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO03872 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-002.
