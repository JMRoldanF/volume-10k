      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL03410'.
      ...
      * Called module names
       01  MOD-ZCL06460              PIC X(8) VALUE 'ZCL06460'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL06460-001.
               CALL 'ZCL06460' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL06460 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
