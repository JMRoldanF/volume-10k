      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01735'.
      ...
      * Called module names
       01  MOD-ZCL04515              PIC X(8) VALUE 'ZCL04515'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL04515-001.
               EXEC CICS LINK PROGRAM('ZCL04515')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL04515 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-002.
