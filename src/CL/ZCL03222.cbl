      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL03222'.
      ...
      * Called module names
       01  MOD-ZCL07537              PIC X(8) VALUE 'ZCL07537'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL07537-001.
               CALL 'ZCL07537' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL07537 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL08435-002.
