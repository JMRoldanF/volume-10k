      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL02869'.
      ...
      * Called module names
       ...
       01  MOD-ZCL06498              PIC X(8) VALUE 'ZCL06498'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL06498-002.
               CALL 'ZCL06498' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL06498 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-003.
