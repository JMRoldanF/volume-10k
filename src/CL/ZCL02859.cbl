      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL02859'.
      ...
      * Called module names
       01  MOD-ZCL06496              PIC X(8) VALUE 'ZCL06496'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL06496-001.
               PERFORM CALL-ZCL06948-002.
               PERFORM CALL-ZCU09998-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCL06496-001.
               CALL 'ZCL06496' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL06496 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL06948-002.
               MOVE 'ZCL06948' TO WS-SUBNAME-3
