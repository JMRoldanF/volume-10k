      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL03998'.
      ...
      * Called module names
       01  MOD-ZCL08201              PIC X(8) VALUE 'ZCL08201'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL08201-001.
               PERFORM CALL-ZHO07956-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL08201-001.
               CALL 'ZCL08201' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL08201 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO07956-002.
