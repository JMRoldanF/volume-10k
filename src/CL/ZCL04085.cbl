      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL04085'.
      ...
      * Called module names
       ...
       01  MOD-ZCL06525              PIC X(8) VALUE 'ZCL06525'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL06525-002.
               CALL 'ZCL06525' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
