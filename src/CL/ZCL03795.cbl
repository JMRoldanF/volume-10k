      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL03795'.
      ...
      * Called module names
       01  MOD-ZCL07435              PIC X(8) VALUE 'ZCL07435'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL07065-001.
               PERFORM CALL-ZCL07435-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL07435-002.
               CALL 'ZCL07435' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL07435 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-003.
