      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL04023'.
      ...
      * Called module names
       ...
       01  MOD-ZCL07128              PIC X(8) VALUE 'ZCL07128'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL08675-001.
               PERFORM CALL-ZCL07128-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL07128-002.
               CALL 'ZCL07128' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL07128 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-003.
