      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL04144'.
      ...
      * Called module names
       01  MOD-ZCL08299              PIC X(8) VALUE 'ZCL08299'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL08299-001.
               CALL 'ZCL08299' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL08299 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL06318-002.
               MOVE 'ZCL06318' TO WS-SUBNAME-2
