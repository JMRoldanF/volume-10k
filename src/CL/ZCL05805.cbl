      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL05805'.
      ...
      * Called module names
       01  MOD-ZCL08645              PIC X(8) VALUE 'ZCL08645'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL08645-001.
               PERFORM CALL-ZAG08098-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL08645-001.
               CALL 'ZCL08645' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL08645 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG08098-002.
