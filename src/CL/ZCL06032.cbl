      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL06032'.
      ...
      * Called module names
       01  MOD-ZCL07757              PIC X(8) VALUE 'ZCL07757'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL07958-001.
               PERFORM CALL-ZCL07757-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL07757-002.
               CALL 'ZCL07757' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL07757 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-003.
