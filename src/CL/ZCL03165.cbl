      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL03165'.
      ...
      * Called module names
       ...
       01  MOD-ZPA06609              PIC X(8) VALUE 'ZPA06609'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL06965-001.
               PERFORM CALL-ZPA06609-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA06609-002.
               CALL 'ZPA06609' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA06609 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-003.
