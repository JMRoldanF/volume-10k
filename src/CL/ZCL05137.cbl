      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL05137'.
      ...
      * Called module names
       01  MOD-ZCL08128              PIC X(8) VALUE 'ZCL08128'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL08128-001.
               CALL 'ZCL08128' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL08128 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-002.
