      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL04295'.
      ...
      * Called module names
       01  MOD-ZCL06912              PIC X(8) VALUE 'ZCL06912'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL06912-001.
               CALL 'ZCL06912' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL06912 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-002.
