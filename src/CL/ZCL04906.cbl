      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL04906'.
      ...
      * Called module names
       ...
       01  MOD-ZCL08108              PIC X(8) VALUE 'ZCL08108'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL08108-002.
               CALL 'ZCL08108' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
