      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL04745'.
      ...
      * Called module names
       01  MOD-ZRE06697              PIC X(8) VALUE 'ZRE06697'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE06697-001.
               CALL 'ZRE06697' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE06697 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
