      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL04336'.
      ...
      * Called module names
       ...
       01  MOD-ZHO08084              PIC X(8) VALUE 'ZHO08084'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO07674-001.
               PERFORM CALL-ZHO08084-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO08084-002.
               CALL 'ZHO08084' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO08084 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-003.
