      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL04115'.
      ...
      * Called module names
       01  MOD-ZCL07035              PIC X(8) VALUE 'ZCL07035'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL07035-001.
               CALL 'ZCL07035' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL07035 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
