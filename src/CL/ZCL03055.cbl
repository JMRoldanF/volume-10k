      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL03055'.
      ...
      * Called module names
       01  MOD-ZRE08267              PIC X(8) VALUE 'ZRE08267'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE08267-001.
               PERFORM CALL-ZUW07180-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE08267-001.
               CALL 'ZRE08267' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE08267 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW07180-002.
