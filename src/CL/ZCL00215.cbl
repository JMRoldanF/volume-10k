      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00215'.
      ...
      * Called module names
       ...
       01  MOD-ZAG00028              PIC X(8) VALUE 'ZAG00028'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG00028-003.
               EXEC CICS XCTL PROGRAM('ZAG00028')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00028 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-004.
