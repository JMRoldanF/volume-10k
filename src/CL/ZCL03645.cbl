      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL03645'.
      ...
      * Called module names
       01  MOD-ZCL06565              PIC X(8) VALUE 'ZCL06565'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL06565-001.
               CALL 'ZCL06565' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL06565 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
