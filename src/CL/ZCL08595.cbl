      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL08595'.
      ...
      * Called module names
       01  MOD-ZCU06497              PIC X(8) VALUE 'ZCU06497'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU06497-001.
               CALL 'ZCU06497' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU06497 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-002.
