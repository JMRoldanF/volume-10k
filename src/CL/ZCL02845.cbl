      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL02845'.
      ...
      * Called module names
       01  MOD-ZCL07725              PIC X(8) VALUE 'ZCL07725'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL07725-001.
               CALL 'ZCL07725' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL07725 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL07065-002.
