      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01875'.
      ...
      * Called module names
       01  MOD-ZCL06275              PIC X(8) VALUE 'ZCL06275'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL03465-001.
               MOVE 'ZCL03465' TO WS-PROGNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZCL06275-002.
               EXEC CICS LINK PROGRAM('ZCL06275')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL06275 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-003.
