      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL03692'.
      ...
      * Called module names
       01  MOD-ZCU07320              PIC X(8) VALUE 'ZCU07320'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU07320-001.
               CALL 'ZCU07320' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU07320 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-002.
