      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03219'.
      ...
      * Called module names
       01  MOD-ZMT08668              PIC X(8) VALUE 'ZMT08668'.
       01  MOD-ZMT07403              PIC X(8) VALUE 'ZMT07403'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT08668-001.
               PERFORM CALL-ZMT07403-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08668-001.
               CALL 'ZMT08668' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08668 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT07403-002.
               CALL 'ZMT07403' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT07403 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
