      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT02851'.
      ...
      * Called module names
       01  MOD-ZMT07957              PIC X(8) VALUE 'ZMT07957'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT07957-001.
               CALL 'ZMT07957' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT07957 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-002.
