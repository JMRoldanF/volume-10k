      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT02197'.
      ...
      * Called module names
       01  MOD-ZMT02826              PIC X(8) VALUE 'ZMT02826'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT02826-001.
               EXEC CICS LINK PROGRAM('ZMT02826')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT02826 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU08649-002.
