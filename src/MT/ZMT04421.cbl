      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04421'.
      ...
      * Called module names
       ...
       01  MOD-ZMT06851              PIC X(8) VALUE 'ZMT06851'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06851-002.
               CALL 'ZMT06851' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06851 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-003.
