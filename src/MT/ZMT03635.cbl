      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03635'.
      ...
      * Called module names
       01  MOD-ZMT06588              PIC X(8) VALUE 'ZMT06588'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT06445-001.
               PERFORM CALL-ZMT06588-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06588-002.
               CALL 'ZMT06588' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06588 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-003.
