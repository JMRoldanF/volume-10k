      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04204'.
      ...
      * Called module names
       ...
       01  MOD-ZMT06800              PIC X(8) VALUE 'ZMT06800'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT07435-001.
               PERFORM CALL-ZMT06800-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06800-002.
               CALL 'ZMT06800' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06800 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-003.
