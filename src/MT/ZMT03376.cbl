      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03376'.
      ...
      * Called module names
       ...
       01  MOD-ZRE07325              PIC X(8) VALUE 'ZRE07325'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA06431-001.
               PERFORM CALL-ZRE07325-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE07325-002.
               CALL 'ZRE07325' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE07325 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-BEDROOMS-0001.
