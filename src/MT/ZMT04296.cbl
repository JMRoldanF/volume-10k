      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04296'.
      ...
      * Called module names
       01  MOD-ZCU07471              PIC X(8) VALUE 'ZCU07471'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU07471-001.
               CALL 'ZCU07471' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU07471 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-002.
