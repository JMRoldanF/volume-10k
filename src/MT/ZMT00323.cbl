      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00323'.
      ...
      * Called module names
       01  MOD-ZAG02057              PIC X(8) VALUE 'ZAG02057'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG02057-001.
               PERFORM CALL-ZMT02187-003.
               PERFORM CALL-ZMT01156-004.
               PERFORM CALL-ZMT02592-005.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG02057-001.
               EXEC CICS LINK PROGRAM('ZAG02057')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG02057 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01341-002.
               MOVE 'ZMT01341' TO WS-PROGNAME-4
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01341 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT02187-003.
               MOVE 'ZMT02187' TO WS-PROGNAME-5
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT02187 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01156-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT02592-005.
               MOVE 'ZMT02592' TO WS-PROGNAME-6
