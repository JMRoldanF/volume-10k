      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03361'.
      ...
      * Called module names
       01  MOD-ZMT08201              PIC X(8) VALUE 'ZMT08201'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT08201-001.
               PERFORM CALL-ZMT06771-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08201-001.
               CALL 'ZMT08201' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08201 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT06771-002.
