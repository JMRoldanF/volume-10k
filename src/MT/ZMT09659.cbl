      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT09659'.
      ...
      * Called module names
       01  MOD-ZMT08099              PIC X(8) VALUE 'ZMT08099'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT08099-001.
               PERFORM CALL-ZPA07290-002.
               PERFORM CALL-ZMT07215-003.
               PERFORM CALL-ZMT06604-004.
               PERFORM CALL-ZMT07071-005.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08099-001.
               CALL 'ZMT08099' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08099 FAILED' TO EM-VARIABLE
