      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03555'.
      ...
      * Called module names
       01  MOD-ZMT07724              PIC X(8) VALUE 'ZMT07724'.
       01  MOD-ZMT07152              PIC X(8) VALUE 'ZMT07152'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT07724-001.
               PERFORM CALL-ZMT07152-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT07724-001.
               CALL 'ZMT07724' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT07724 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT07152-002.
               CALL 'ZMT07152' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
