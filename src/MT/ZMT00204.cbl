      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00204'.
      ...
      * Called module names
       01  MOD-ZMT00947              PIC X(8) VALUE 'ZMT00947'.
       01  MOD-ZMT02479              PIC X(8) VALUE 'ZMT02479'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT02479-002.
               PERFORM CALL-ZMT02479-003.
               PERFORM CALL-ZRE02583-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00947-001.
               EXEC CICS LINK PROGRAM('ZMT00947')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00947 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT02479-002.
               EXEC CICS LINK PROGRAM('ZMT02479')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
