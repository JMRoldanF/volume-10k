      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT09769'.
      ...
      * Called module names
       ...
       01  MOD-ZMT02897              PIC X(8) VALUE 'ZMT02897'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT02897-003.
               CALL 'ZMT02897' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
