      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03673'.
      ...
      * Called module names
       01  MOD-ZMT07119              PIC X(8) VALUE 'ZMT07119'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT07119-001.
               PERFORM CALL-ZCU08070-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT07119-001.
               CALL 'ZMT07119' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT07119 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU08070-002.
