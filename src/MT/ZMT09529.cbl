      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT09529'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT07138-001.
               PERFORM CALL-ZEN07588-003.
               PERFORM CALL-ZMT04575-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT04575-004.
               CALL 'ZMT04575' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
