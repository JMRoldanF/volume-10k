      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT07097'.
      ...
      * Called module names
       01  MOD-ZMT07907              PIC X(8) VALUE 'ZMT07907'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT07907-001.
               CALL 'ZMT07907' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT07907 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-002.
