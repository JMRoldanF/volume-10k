      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04722'.
      ...
      * Called module names
       01  MOD-ZMT08200              PIC X(8) VALUE 'ZMT08200'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT08200-001.
               PERFORM CALL-ZAG07140-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08200-001.
               CALL 'ZMT08200' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08200 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG07140-002.
