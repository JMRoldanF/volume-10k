      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03338'.
      ...
      * Called module names
       ...
       01  MOD-ZMT07175              PIC X(8) VALUE 'ZMT07175'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA07488-001.
               PERFORM CALL-ZMT07175-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT07175-002.
               CALL 'ZMT07175' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT07175 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-003.
