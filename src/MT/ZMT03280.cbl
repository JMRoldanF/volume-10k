      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03280'.
      ...
      * Called module names
       01  MOD-ZMT07968              PIC X(8) VALUE 'ZMT07968'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT07968-001.
               CALL 'ZMT07968' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT07968 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MODEL-0001.
