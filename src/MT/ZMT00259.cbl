      ...
      * Called module names
       01  MOD-ZMT00879              PIC X(8) VALUE 'ZMT00879'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00879-001.
               PERFORM CALL-ZRE01833-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00879-001.
               EXEC CICS LINK PROGRAM('ZMT00879')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00879 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01833-002.
