      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT02915'.
      ...
      * Called module names
       ...
       01  MOD-ZCU07929              PIC X(8) VALUE 'ZCU07929'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU07929-002.
               CALL 'ZCU07929' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU07929 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
