      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT05512'.
      ...
      * Called module names
       01  MOD-ZMT07806              PIC X(8) VALUE 'ZMT07806'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT07806-001.
               PERFORM CALL-ZCU09998-002.
               PERFORM DERIVE-MAKE-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT07806-001.
               CALL 'ZMT07806' USING DFHCOMMAREA
                         WS-STATUS-CODE.
