      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04759'.
      ...
      * Called module names
       01  MOD-ZMT06414              PIC X(8) VALUE 'ZMT06414'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT06414-001.
               PERFORM CALL-ZMT07403-002.
               PERFORM CALL-ZEN09997-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT06414-001.
               CALL 'ZMT06414' USING DFHCOMMAREA
                         WS-STATUS-CODE.
