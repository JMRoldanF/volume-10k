      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03194'.
      ...
      * Called module names
       01  MOD-ZMT07006              PIC X(8) VALUE 'ZMT07006'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT07006-001.
               PERFORM CALL-ZPA07495-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT07006-001.
               CALL 'ZMT07006' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT07006 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA07495-002.
