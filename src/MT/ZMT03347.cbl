      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03347'.
      ...
      * Called module names
       01  MOD-ZMT08104              PIC X(8) VALUE 'ZMT08104'.
       01  MOD-ZMT06735              PIC X(8) VALUE 'ZMT06735'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08104-001.
               CALL 'ZMT08104' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08104 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT06735-002.
               CALL 'ZMT06735' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06735 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-COLOUR-0001.
