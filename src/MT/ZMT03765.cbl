      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03765'.
      ...
      * Called module names
       01  MOD-ZMT07616              PIC X(8) VALUE 'ZMT07616'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT07616-001.
               CALL 'ZMT07616' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT07616 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
