      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT05784'.
      ...
      * Called module names
       ...
       01  MOD-ZMT06673              PIC X(8) VALUE 'ZMT06673'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06673-002.
               CALL 'ZMT06673' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06673 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
