      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03484'.
      ...
      * Called module names
       01  MOD-ZMT06488              PIC X(8) VALUE 'ZMT06488'.
       01  MOD-ZMT06344              PIC X(8) VALUE 'ZMT06344'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT06488-001.
               PERFORM CALL-ZMT06344-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06488-001.
               CALL 'ZMT06488' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06488 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT06344-002.
               CALL 'ZMT06344' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06344 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
