      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04896'.
      ...
      * Called module names
       01  MOD-ZRE06680              PIC X(8) VALUE 'ZRE06680'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE06680-001.
               CALL 'ZRE06680' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE06680 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MODEL-0001.
