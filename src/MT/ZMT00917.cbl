      ...
      * Called module names
       ...
       01  MOD-ZMT07048              PIC X(8) VALUE 'ZMT07048'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT03572-001.
               PERFORM CALL-ZMT05632-002.
               PERFORM CALL-ZMT07048-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT05632-002.
               MOVE 'ZMT05632' TO WS-PROGNAME-7
      ...
      *----------------------------------------------------------------*
       CALL-ZMT07048-003.
               CALL 'ZMT07048' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
