      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04349'.
      ...
      * Called module names
       01  MOD-ZMT08423              PIC X(8) VALUE 'ZMT08423'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08423-001.
               CALL 'ZMT08423' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08423 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG06967-002.
               MOVE 'ZAG06967' TO WS-SUBNAME-7
