      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04328'.
      ...
      * Called module names
       01  MOD-ZMT08500              PIC X(8) VALUE 'ZMT08500'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT08500-001.
               PERFORM CALL-ZMT07012-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08500-001.
               CALL 'ZMT08500' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08500 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT07012-002.
