      ...
      * Called module names
       01  MOD-ZMT00851              PIC X(8) VALUE 'ZMT00851'.
       01  MOD-ZMT02361              PIC X(8) VALUE 'ZMT02361'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00851-001.
               PERFORM CALL-ZMT02361-002.
               PERFORM CALL-ZMT01871-003.
               PERFORM CALL-ZMT01411-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00851-001.
               EXEC CICS LINK PROGRAM('ZMT00851')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00851 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT02361-002.
               EXEC CICS LINK PROGRAM('ZMT02361')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT02361 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01871-003.
               MOVE 'ZMT01871' TO WS-PROGNAME-8
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01871 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01411-004.
