      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03344'.
      ...
      * Called module names
       01  MOD-ZMT07905              PIC X(8) VALUE 'ZMT07905'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT07905-001.
               CALL 'ZMT07905' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT07905 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-002.
