      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03668'.
      ...
      * Called module names
       01  MOD-ZMT06589              PIC X(8) VALUE 'ZMT06589'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06589-001.
               CALL 'ZMT06589' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06589 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA08682-002.
