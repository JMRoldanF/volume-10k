      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT02845'.
      ...
      * Called module names
       01  MOD-ZMT06454              PIC X(8) VALUE 'ZMT06454'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT06454-001.
               PERFORM CALL-ZMT07903-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06454-001.
               CALL 'ZMT06454' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06454 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT07903-002.
