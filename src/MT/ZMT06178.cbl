      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT06178'.
      ...
      * Called module names
       01  MOD-ZMT08037              PIC X(8) VALUE 'ZMT08037'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT08037-001.
               PERFORM CALL-ZAG08336-002.
               PERFORM CALL-ZEN09997-003.
               PERFORM COMPUTE-PREMIUM-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT08037-001.
               CALL 'ZMT08037' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08037 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG08336-002.
