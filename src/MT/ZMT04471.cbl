      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04471'.
      ...
      * Called module names
       ...
       01  MOD-ZMT07361              PIC X(8) VALUE 'ZMT07361'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT07361-002.
               CALL 'ZMT07361' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT07361 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-003.
