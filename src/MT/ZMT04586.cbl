      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04586'.
      ...
      * Called module names
       01  MOD-ZMT08534              PIC X(8) VALUE 'ZMT08534'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08534-001.
               CALL 'ZMT08534' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08534 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-002.
