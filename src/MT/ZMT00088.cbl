      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00088'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01683              PIC X(8) VALUE 'ZMT01683'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01683-002.
               EXEC CICS LINK PROGRAM('ZMT01683')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01683 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-003.
