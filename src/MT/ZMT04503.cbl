      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04503'.
      ...
      * Called module names
       01  MOD-ZMT08526              PIC X(8) VALUE 'ZMT08526'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08526-001.
               CALL 'ZMT08526' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08526 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT07942-002.
