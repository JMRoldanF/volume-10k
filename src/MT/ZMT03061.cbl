      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03061'.
      ...
      * Called module names
       01  MOD-ZCU08504              PIC X(8) VALUE 'ZCU08504'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU08504-001.
               CALL 'ZCU08504' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU08504 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-002.
