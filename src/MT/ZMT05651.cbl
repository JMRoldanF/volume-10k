      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT05651'.
      ...
      * Called module names
       01  MOD-ZMT06321              PIC X(8) VALUE 'ZMT06321'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT06321-001.
               PERFORM CALL-ZBI10000-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT06321-001.
               CALL 'ZMT06321' USING DFHCOMMAREA
                         WS-STATUS-CODE.
