      ...
      * Called module names
       ...
       01  MOD-ZMT03493              PIC X(8) VALUE 'ZMT03493'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT03493-003.
               CALL 'ZMT03493' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT03493 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
