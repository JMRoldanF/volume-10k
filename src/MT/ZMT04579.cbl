      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04579'.
      ...
      * Called module names
       ...
       01  MOD-ZMT07702              PIC X(8) VALUE 'ZMT07702'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT07702-002.
               CALL 'ZMT07702' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
