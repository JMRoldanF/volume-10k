      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03311'.
      ...
      * Called module names
       01  MOD-ZMT06371              PIC X(8) VALUE 'ZMT06371'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT06371-001.
               PERFORM CALL-ZMT07371-002.
               PERFORM CALL-ZMT09995-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT06371-001.
               CALL 'ZMT06371' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06371 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT07371-002.
               MOVE 'ZMT07371' TO WS-SUBNAME-6
