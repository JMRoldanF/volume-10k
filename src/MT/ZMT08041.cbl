      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT08041'.
      ...
      * Called module names
       01  MOD-ZRE07527              PIC X(8) VALUE 'ZRE07527'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE07527-001.
               CALL 'ZRE07527' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE07527 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-002.
