      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT08413'.
      ...
      * Called module names
       01  MOD-ZMT06522              PIC X(8) VALUE 'ZMT06522'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06522-001.
               CALL 'ZMT06522' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06522 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-002.
