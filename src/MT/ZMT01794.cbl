      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01794'.
      ...
      * Called module names
       ...
       01  MOD-ZRE06244              PIC X(8) VALUE 'ZRE06244'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT04671-001.
               PERFORM CALL-ZMT07159-003.
               PERFORM CALL-ZMT07838-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE06244-002.
               EXEC CICS LINK PROGRAM('ZRE06244')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE06244 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT07159-003.
