      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04762'.
      ...
      * Called module names
       01  MOD-ZMT06748              PIC X(8) VALUE 'ZMT06748'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06748-001.
               CALL 'ZMT06748' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06748 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
