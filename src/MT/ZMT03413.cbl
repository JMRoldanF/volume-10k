      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03413'.
      ...
      * Called module names
       01  MOD-ZCU07442              PIC X(8) VALUE 'ZCU07442'.
       01  MOD-ZMT08614              PIC X(8) VALUE 'ZMT08614'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU07442-001.
               CALL 'ZCU07442' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU07442 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT08614-002.
               CALL 'ZMT08614' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08614 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
