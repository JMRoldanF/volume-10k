      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT08234'.
      ...
      * Called module names
       01  MOD-ZMT08324              PIC X(8) VALUE 'ZMT08324'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08324-001.
               CALL 'ZMT08324' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08324 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-002.
