      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04323'.
      ...
      * Called module names
       ...
       01  MOD-ZMT06805              PIC X(8) VALUE 'ZMT06805'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT06706-001.
               PERFORM CALL-ZMT06805-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06805-002.
               CALL 'ZMT06805' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06805 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-003.
