      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03120'.
      ...
      * Called module names
       01  MOD-ZMT08398              PIC X(8) VALUE 'ZMT08398'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT08398-002.
               PERFORM CALL-ZMT09995-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPA06905-001.
               MOVE 'ZPA06905' TO WS-SUBNAME-5
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08398-002.
               CALL 'ZMT08398' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08398 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-003.
