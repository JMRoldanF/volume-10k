      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04311'.
      ...
      * Called module names
       ...
       01  MOD-ZMT06931              PIC X(8) VALUE 'ZMT06931'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06931-002.
               CALL 'ZMT06931' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
