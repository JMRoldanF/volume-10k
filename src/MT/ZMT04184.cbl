      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04184'.
      ...
      * Called module names
       ...
       01  MOD-ZMT08622              PIC X(8) VALUE 'ZMT08622'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08622-002.
               CALL 'ZMT08622' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08622 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-003.
