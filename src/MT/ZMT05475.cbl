      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT05475'.
      ...
      * Called module names
       01  MOD-ZMT08446              PIC X(8) VALUE 'ZMT08446'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08446-001.
               CALL 'ZMT08446' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08446 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-002.
