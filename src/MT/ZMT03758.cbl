      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03758'.
      ...
      * Called module names
       ...
       01  MOD-ZCU06812              PIC X(8) VALUE 'ZCU06812'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT06458-001.
               PERFORM CALL-ZCU06812-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU06812-002.
               CALL 'ZCU06812' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU06812 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-003.
