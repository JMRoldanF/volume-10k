      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04111'.
      ...
      * Called module names
       01  MOD-ZMT06351              PIC X(8) VALUE 'ZMT06351'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06351-001.
               CALL 'ZMT06351' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06351 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-002.
