      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04314'.
      ...
      * Called module names
       01  MOD-ZAG06383              PIC X(8) VALUE 'ZAG06383'.
       01  MOD-ZMT08199              PIC X(8) VALUE 'ZMT08199'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG06383-001.
               CALL 'ZAG06383' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG06383 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT08199-002.
               CALL 'ZMT08199' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
