      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04470'.
      ...
      * Called module names
       01  MOD-ZMT08504              PIC X(8) VALUE 'ZMT08504'.
       01  MOD-ZMT06880              PIC X(8) VALUE 'ZMT06880'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08504-001.
               CALL 'ZMT08504' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08504 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT06880-002.
               CALL 'ZMT06880' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06880 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
