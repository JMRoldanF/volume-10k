      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT09197'.
      ...
      * Called module names
       ...
       01  MOD-ZMT03981              PIC X(8) VALUE 'ZMT03981'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT07164-001.
               PERFORM CALL-ZMT08112-002.
               PERFORM CALL-ZMT06548-003.
               PERFORM CALL-ZCU07878-004.
               PERFORM CALL-ZMT07322-005.
               PERFORM CALL-ZMT03981-006.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06548-003.
               MOVE 'ZMT06548' TO WS-SUBNAME-5
               CALL WS-SUBNAME-5 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06548 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU07878-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT03981-006.
               CALL 'ZMT03981' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
