      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03919'.
      ...
      * Called module names
       ...
       01  MOD-ZMT07549              PIC X(8) VALUE 'ZMT07549'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT07549-002.
               CALL 'ZMT07549' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT07549 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
