      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT04720'.
      ...
      * Called module names
       01  MOD-ZMT08066              PIC X(8) VALUE 'ZMT08066'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT08066-001.
               PERFORM CALL-ZMT09995-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT08066-001.
               CALL 'ZMT08066' USING DFHCOMMAREA
                         WS-STATUS-CODE.
