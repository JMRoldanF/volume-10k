      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03351'.
      ...
      * Called module names
       01  MOD-ZMT06484              PIC X(8) VALUE 'ZMT06484'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06484-002.
               CALL 'ZMT06484' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06484 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
