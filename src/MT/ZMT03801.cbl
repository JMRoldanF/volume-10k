      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03801'.
      ...
      * Called module names
       ...
       01  MOD-ZCU08434              PIC X(8) VALUE 'ZCU08434'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT07831-001.
               PERFORM CALL-ZCU08434-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU08434-002.
               CALL 'ZCU08434' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU08434 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
