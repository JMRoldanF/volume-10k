      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT02841'.
      ...
      * Called module names
       01  MOD-ZMT08111              PIC X(8) VALUE 'ZMT08111'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08111-001.
               CALL 'ZMT08111' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08111 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EQUITIES-0001.
