      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03029'.
      ...
      * Called module names
       01  MOD-ZMT08075              PIC X(8) VALUE 'ZMT08075'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08075-001.
               CALL 'ZMT08075' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08075 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
