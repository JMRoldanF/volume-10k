      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT05081'.
      ...
      * Called module names
       01  MOD-ZMT07179              PIC X(8) VALUE 'ZMT07179'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT07179-001.
               CALL 'ZMT07179' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT07179 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT07416-002.
               MOVE 'ZMT07416' TO WS-SUBNAME-1
