      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT03634'.
      ...
      * Called module names
       01  MOD-ZMT06712              PIC X(8) VALUE 'ZMT06712'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06712-001.
               CALL 'ZMT06712' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06712 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-002.
