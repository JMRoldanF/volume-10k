      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU04632'.
      ...
      * Called module names
       ...
       01  MOD-ZPA08062              PIC X(8) VALUE 'ZPA08062'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU08521-001.
               PERFORM CALL-ZPA08062-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA08062-002.
               CALL 'ZPA08062' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA08062 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
