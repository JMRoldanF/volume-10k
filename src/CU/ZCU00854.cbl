      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00854'.
      ...
      * Called module names
       ...
       01  MOD-ZPA04089              PIC X(8) VALUE 'ZPA04089'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU03224-001.
               PERFORM CALL-ZBI04836-002.
               PERFORM CALL-ZPA04089-003.
               PERFORM CALL-ZCL09999-004.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU03224-001.
               MOVE 'ZCU03224' TO WS-PROGNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZPA04089-003.
               EXEC CICS LINK PROGRAM('ZPA04089')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA04089 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-004.
