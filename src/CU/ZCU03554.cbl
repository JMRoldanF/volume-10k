      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU03554'.
      ...
      * Called module names
       ...
       01  MOD-ZRE06887              PIC X(8) VALUE 'ZRE06887'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW08010-001.
               PERFORM CALL-ZRE06887-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE06887-002.
               CALL 'ZRE06887' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE06887 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-003.
