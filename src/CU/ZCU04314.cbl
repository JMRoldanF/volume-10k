      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU04314'.
      ...
      * Called module names
       01  MOD-ZCU08004              PIC X(8) VALUE 'ZCU08004'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU08004-001.
               PERFORM CALL-ZCU07364-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU08004-001.
               CALL 'ZCU08004' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU08004 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU07364-002.
