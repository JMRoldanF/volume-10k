      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU02849'.
      ...
      * Called module names
       01  MOD-ZCU07933              PIC X(8) VALUE 'ZCU07933'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU07933-001.
               CALL 'ZCU07933' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU07933 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-002.
