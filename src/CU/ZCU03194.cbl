      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU03194'.
      ...
      * Called module names
       ...
       01  MOD-ZCU07694              PIC X(8) VALUE 'ZCU07694'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU07694-002.
               CALL 'ZCU07694' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU07694 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-003.
