      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU05306'.
      ...
      * Called module names
       ...
       01  MOD-ZCU07301              PIC X(8) VALUE 'ZCU07301'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU07301-002.
               CALL 'ZCU07301' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU07301 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-003.
