      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU05352'.
      ...
      * Called module names
       ...
       01  MOD-ZCU07768              PIC X(8) VALUE 'ZCU07768'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU08654-001.
               PERFORM CALL-ZCU07768-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU07768-002.
               CALL 'ZCU07768' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU07768 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-MAKE-0001.
