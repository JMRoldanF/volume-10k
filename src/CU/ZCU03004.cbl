      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU03004'.
      ...
      * Called module names
       ...
       01  MOD-ZCU06454              PIC X(8) VALUE 'ZCU06454'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI07356-001.
               PERFORM CALL-ZCU06454-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU06454-002.
               CALL 'ZCU06454' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU06454 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-VALUE-0001.
