      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU03214'.
      ...
      * Called module names
       ...
       01  MOD-ZCL06885              PIC X(8) VALUE 'ZCL06885'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL06885-002.
               CALL 'ZCL06885' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL06885 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
