      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU04154'.
      ...
      * Called module names
       01  MOD-ZCU07609              PIC X(8) VALUE 'ZCU07609'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU07609-001.
               CALL 'ZCU07609' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU07609 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
