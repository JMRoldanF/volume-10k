      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU07794'.
      ...
      * Called module names
       01  MOD-ZCU07796              PIC X(8) VALUE 'ZCU07796'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU07796-001.
               PERFORM CALL-ZCU07328-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU07796-001.
               CALL 'ZCU07796' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU07796 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU07328-002.
               MOVE 'ZCU07328' TO WS-SUBNAME-6
