      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU04109'.
      ...
      * Called module names
       01  MOD-ZPA07351              PIC X(8) VALUE 'ZPA07351'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA07351-001.
               PERFORM CALL-ZCU07281-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA07351-001.
               CALL 'ZPA07351' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA07351 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU07281-002.
