      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU05584'.
      ...
      * Called module names
       01  MOD-ZCL06945              PIC X(8) VALUE 'ZCL06945'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL06945-001.
               CALL 'ZCL06945' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL06945 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-002.
