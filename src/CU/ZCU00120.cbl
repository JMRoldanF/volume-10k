      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00120'.
      ...
      * Called module names
       ...
       01  MOD-ZRE00160              PIC X(8) VALUE 'ZRE00160'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01943-001.
               PERFORM CALL-ZCU01308-002.
               PERFORM CALL-ZRE00160-003.
               PERFORM CALL-ZCU00357-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01308-002.
               MOVE 'ZCU01308' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00160-003.
               EXEC CICS XCTL PROGRAM('ZRE00160')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00160 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00357-004.
               EXEC CICS START TRANSID('Z09X')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z09X is defined against ZCU00357
               IF WS-RESP NOT = DFHRESP(NORMAL)
