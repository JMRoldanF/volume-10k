      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU04615'.
      ...
      * Called module names
       01  MOD-ZCU06853              PIC X(8) VALUE 'ZCU06853'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU06853-001.
               PERFORM CALL-ZPA08682-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU06853-001.
               CALL 'ZCU06853' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU06853 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA08682-002.
