      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU03924'.
      ...
      * Called module names
       ...
       01  MOD-ZCU06384              PIC X(8) VALUE 'ZCU06384'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU06384-002.
               CALL 'ZCU06384' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU06384 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
