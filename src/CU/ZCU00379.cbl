      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00379'.
      ...
      * Called module names
       01  MOD-ZCU02597              PIC X(8) VALUE 'ZCU02597'.
       01  MOD-ZCU02798              PIC X(8) VALUE 'ZCU02798'.
       01  MOD-ZCU00004              PIC X(8) VALUE 'ZCU00004'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU02798-002.
               PERFORM CALL-ZCU00004-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU02597-001.
               EXEC CICS LINK PROGRAM('ZCU02597')
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00004-003.
               EXEC CICS XCTL PROGRAM('ZCU00004')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
