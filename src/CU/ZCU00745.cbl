      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00745'.
      ...
      * Called module names
       01  MOD-ZCU01892              PIC X(8) VALUE 'ZCU01892'.
       01  MOD-ZCU01265              PIC X(8) VALUE 'ZCU01265'.
       01  MOD-ZCU01208              PIC X(8) VALUE 'ZCU01208'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01892-001.
               PERFORM CALL-ZCU01265-002.
               PERFORM CALL-ZCU01208-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01892-001.
               EXEC CICS LINK PROGRAM('ZCU01892')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01892 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01265-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01208-003.
               EXEC CICS LINK PROGRAM('ZCU01208')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01208 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU02650-004.
