      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU09428'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU07424-001.
               PERFORM CALL-ZCU07474-002.
               PERFORM CALL-ZCU08604-003.
               PERFORM CALL-ZCU02824-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU02824-004.
               CALL 'ZCU02824' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
