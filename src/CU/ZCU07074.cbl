      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU07074'.
      ...
      * Called module names
       01  MOD-ZCL07455              PIC X(8) VALUE 'ZCL07455'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL07455-001.
               CALL 'ZCL07455' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL07455 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
