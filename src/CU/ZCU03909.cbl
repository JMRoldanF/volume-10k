      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU03909'.
      ...
      * Called module names
       01  MOD-ZHO07045              PIC X(8) VALUE 'ZHO07045'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO07045-001.
               PERFORM CALL-ZCU08167-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO07045-001.
               CALL 'ZHO07045' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO07045 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU08167-002.
