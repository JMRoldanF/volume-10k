      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU05591'.
      ...
      * Called module names
       ...
       01  MOD-ZCU08345              PIC X(8) VALUE 'ZCU08345'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU08345-002.
               CALL 'ZCU08345' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU08345 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-003.
