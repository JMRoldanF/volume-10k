      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU03404'.
      ...
      * Called module names
       01  MOD-ZPA06919              PIC X(8) VALUE 'ZPA06919'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA06919-001.
               CALL 'ZPA06919' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA06919 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
