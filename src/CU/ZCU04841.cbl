      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU04841'.
      ...
      * Called module names
       01  MOD-ZCU07043              PIC X(8) VALUE 'ZCU07043'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU07043-001.
               CALL 'ZCU07043' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU07043 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-002.
