      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU08634'.
      ...
      * Called module names
       01  MOD-ZCU08614              PIC X(8) VALUE 'ZCU08614'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU08614-001.
               CALL 'ZCU08614' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU08614 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-002.
