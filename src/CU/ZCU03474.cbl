      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU03474'.
      ...
      * Called module names
       01  MOD-ZCU06934              PIC X(8) VALUE 'ZCU06934'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU06934-001.
               PERFORM CALL-ZCU07774-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU06934-001.
               CALL 'ZCU06934' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU06934 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU07774-002.
