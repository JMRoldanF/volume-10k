      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU08064'.
      ...
      * Called module names
       01  MOD-ZUW08250              PIC X(8) VALUE 'ZUW08250'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW08250-001.
               CALL 'ZUW08250' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW08250 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-002.
