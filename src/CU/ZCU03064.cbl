      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU03064'.
      ...
      * Called module names
       ...
       01  MOD-ZCU06344              PIC X(8) VALUE 'ZCU06344'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU06344-002.
               CALL 'ZCU06344' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
