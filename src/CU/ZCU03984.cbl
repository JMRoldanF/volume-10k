      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU03984'.
      ...
      * Called module names
       ...
       01  MOD-ZCU06604              PIC X(8) VALUE 'ZCU06604'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU06604-002.
               CALL 'ZCU06604' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU06604 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
