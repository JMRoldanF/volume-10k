      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU02844'.
      ...
      * Called module names
       ...
       01  MOD-ZAG08038              PIC X(8) VALUE 'ZAG08038'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL07945-001.
               PERFORM CALL-ZAG08038-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG08038-002.
               CALL 'ZAG08038' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG08038 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-003.
