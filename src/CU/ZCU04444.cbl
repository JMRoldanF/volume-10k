      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU04444'.
      ...
      * Called module names
       ...
       01  MOD-ZCU07484              PIC X(8) VALUE 'ZCU07484'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU07484-002.
               CALL 'ZCU07484' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU07484 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-003.
