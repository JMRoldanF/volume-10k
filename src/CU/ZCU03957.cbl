      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU03957'.
      ...
      * Called module names
       ...
       01  MOD-ZCU06687              PIC X(8) VALUE 'ZCU06687'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU07489-001.
               PERFORM CALL-ZCU06687-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU06687-002.
               CALL 'ZCU06687' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU06687 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-COLOUR-0001.
