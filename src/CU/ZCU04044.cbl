      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU04044'.
      ...
      * Called module names
       01  MOD-ZCU08084              PIC X(8) VALUE 'ZCU08084'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU08084-001.
               CALL 'ZCU08084' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU08084 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU07844-002.
