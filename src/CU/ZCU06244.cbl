      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU06244'.
      ...
      * Called module names
       01  MOD-ZCU07834              PIC X(8) VALUE 'ZCU07834'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU07834-001.
               CALL 'ZCU07834' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU07834 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-TERM-0001.
