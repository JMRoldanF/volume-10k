      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU07754'.
      ...
      * Called module names
       01  MOD-ZPA06629              PIC X(8) VALUE 'ZPA06629'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA06629-001.
               CALL 'ZPA06629' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA06629 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
