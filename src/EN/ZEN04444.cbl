      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN04444'.
      ...
      * Called module names
       01  MOD-ZAG08256              PIC X(8) VALUE 'ZAG08256'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG08256-001.
               CALL 'ZAG08256' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG08256 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN06596-002.
