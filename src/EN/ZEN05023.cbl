      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN05023'.
      ...
      * Called module names
       01  MOD-ZEN07793              PIC X(8) VALUE 'ZEN07793'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN07553-001.
               PERFORM CALL-ZEN07793-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN07793-002.
               CALL 'ZEN07793' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN07793 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-003.
