      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN04938'.
      ...
      * Called module names
       ...
       01  MOD-ZEN08114              PIC X(8) VALUE 'ZEN08114'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN08114-002.
               CALL 'ZEN08114' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN08114 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
