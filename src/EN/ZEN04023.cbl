      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN04023'.
      ...
      * Called module names
       01  MOD-ZEN06813              PIC X(8) VALUE 'ZEN06813'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN06813-001.
               CALL 'ZEN06813' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN06813 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-002.
