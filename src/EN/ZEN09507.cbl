      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN09507'.
      ...
      * Called module names
       01  MOD-ZEN07503              PIC X(8) VALUE 'ZEN07503'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN08163-001.
               PERFORM CALL-ZEN07503-002.
               PERFORM CALL-ZEN06843-003.
               PERFORM CALL-ZPA06359-004.
               PERFORM CALL-ZEN07623-005.
               PERFORM CALL-ZEN03263-006.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN08163-001.
               MOVE 'ZEN08163' TO WS-SUBNAME-2
               CALL WS-SUBNAME-2 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN08163 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN07503-002.
               CALL 'ZEN07503' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN07503 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN06843-003.
               MOVE 'ZEN06843' TO WS-SUBNAME-3
