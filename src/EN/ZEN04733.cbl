      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN04733'.
      ...
      * Called module names
       01  MOD-ZEN07653              PIC X(8) VALUE 'ZEN07653'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN07653-001.
               CALL 'ZEN07653' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN07653 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
