      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN03802'.
      ...
      * Called module names
       ...
       01  MOD-ZEN06596              PIC X(8) VALUE 'ZEN06596'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU06483-001.
               PERFORM CALL-ZEN06596-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN06596-002.
               CALL 'ZEN06596' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN06596 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
