      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN03792'.
      ...
      * Called module names
       01  MOD-ZCL07132              PIC X(8) VALUE 'ZCL07132'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL07132-001.
               PERFORM CALL-ZUW06315-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL07132-001.
               CALL 'ZCL07132' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL07132 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW06315-002.
