      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01826'.
      ...
      * Called module names
       01  MOD-ZEN03446              PIC X(8) VALUE 'ZEN03446'.
       01  MOD-ZEN04859              PIC X(8) VALUE 'ZEN04859'.
       01  MOD-ZEN07637              PIC X(8) VALUE 'ZEN07637'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN03446-001.
               PERFORM CALL-ZEN04859-002.
               PERFORM CALL-ZEN07637-003.
               PERFORM CALL-ZEN08480-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN03446-001.
               EXEC CICS LINK PROGRAM('ZEN03446')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN03446 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN04859-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN07637-003.
               CALL 'ZEN07637' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
