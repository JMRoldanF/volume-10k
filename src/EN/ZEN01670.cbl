      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01670'.
      ...
      * Called module names
       ...
       01  MOD-ZEN04686              PIC X(8) VALUE 'ZEN04686'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN04686-002.
               EXEC CICS LINK PROGRAM('ZEN04686')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
