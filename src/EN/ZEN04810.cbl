      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN04810'.
      ...
      * Called module names
       01  MOD-ZEN06666              PIC X(8) VALUE 'ZEN06666'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN06666-001.
               PERFORM CALL-ZEN08405-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN06666-001.
               CALL 'ZEN06666' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN06666 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN08405-002.
