      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN02973'.
      ...
      * Called module names
       ...
       01  MOD-ZMT08161              PIC X(8) VALUE 'ZMT08161'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08161-002.
               CALL 'ZMT08161' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08161 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
