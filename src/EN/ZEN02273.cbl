      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN02273'.
      ...
      * Called module names
       01  MOD-ZCL05027              PIC X(8) VALUE 'ZCL05027'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN04520-001.
               PERFORM CALL-ZCL05027-002.
               PERFORM CALL-ZEN05992-003.
               PERFORM CALL-ZEN07189-004.
               PERFORM CALL-ZEN07072-005.
               PERFORM CALL-ZBI10000-006.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN04520-001.
               MOVE 'ZEN04520' TO WS-PROGNAME-6
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN04520 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL05027-002.
               EXEC CICS LINK PROGRAM('ZCL05027')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL05027 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN05992-003.
