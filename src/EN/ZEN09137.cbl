      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN09137'.
      ...
      * Called module names
       ...
       01  MOD-ZEN06443              PIC X(8) VALUE 'ZEN06443'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN06963-001.
               PERFORM CALL-ZEN07303-002.
               PERFORM CALL-ZEN06443-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN06443-003.
               CALL 'ZEN06443' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
