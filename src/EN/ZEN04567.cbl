      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN04567'.
      ...
      * Called module names
       01  MOD-ZEN08251              PIC X(8) VALUE 'ZEN08251'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN08251-001.
               PERFORM CALL-ZEN08623-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN08251-001.
               CALL 'ZEN08251' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN08251 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN08623-002.
