      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN06320'.
      ...
      * Called module names
       01  MOD-ZEN07524              PIC X(8) VALUE 'ZEN07524'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN07524-001.
               CALL 'ZEN07524' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN07524 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-002.
