      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00436'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01650-001.
               PERFORM CALL-ZCU01461-002.
               PERFORM CALL-ZEN01671-003.
               PERFORM CALL-ZEN01996-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01650-001.
               MOVE 'ZEN01650' TO WS-PROGNAME-4
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01650 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01461-002.
               MOVE 'ZCU01461' TO WS-PROGNAME-5
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01671-003.
               MOVE 'ZEN01671' TO WS-PROGNAME-6
