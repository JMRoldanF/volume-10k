      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN02803'.
      ...
      * Called module names
       ...
       01  MOD-ZUW06668              PIC X(8) VALUE 'ZUW06668'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL08241-001.
               PERFORM CALL-ZUW06668-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW06668-002.
               CALL 'ZUW06668' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW06668 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-003.
