      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN04487'.
      ...
      * Called module names
       01  MOD-ZEN07437              PIC X(8) VALUE 'ZEN07437'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN07437-001.
               CALL 'ZEN07437' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN07437 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EXCESS-0001.
