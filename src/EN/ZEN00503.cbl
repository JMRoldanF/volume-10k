      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00503'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01053              PIC X(8) VALUE 'ZEN01053'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN02693-001.
               PERFORM CALL-ZEN01013-002.
               PERFORM CALL-ZEN01053-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN02693-001.
               MOVE 'ZEN02693' TO WS-PROGNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01053-003.
               EXEC CICS LINK PROGRAM('ZEN01053')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01053 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-004.
