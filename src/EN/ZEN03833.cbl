      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN03833'.
      ...
      * Called module names
       01  MOD-ZBI07476              PIC X(8) VALUE 'ZBI07476'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI07476-001.
               PERFORM CALL-ZRE07637-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI07476-001.
               CALL 'ZBI07476' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI07476 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE07637-002.
