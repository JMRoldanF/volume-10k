      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN05879'.
      ...
      * Called module names
       ...
       01  MOD-ZEN07647              PIC X(8) VALUE 'ZEN07647'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN07647-002.
               CALL 'ZEN07647' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN07647 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-003.
