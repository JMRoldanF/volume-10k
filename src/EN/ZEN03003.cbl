      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN03003'.
      ...
      * Called module names
       01  MOD-ZEN06753              PIC X(8) VALUE 'ZEN06753'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN06753-001.
               CALL 'ZEN06753' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN06753 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
