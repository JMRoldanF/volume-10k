      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN08977'.
      ...
      * Called module names
       ...
       01  MOD-ZEN06983              PIC X(8) VALUE 'ZEN06983'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN08653-001.
               PERFORM CALL-ZEN07723-002.
               PERFORM CALL-ZEN06983-003.
               PERFORM CALL-ZEN06423-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN06983-003.
               CALL 'ZEN06983' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN06983 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN06423-004.
