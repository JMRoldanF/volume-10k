      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN04157'.
      ...
      * Called module names
       01  MOD-ZAG07992              PIC X(8) VALUE 'ZAG07992'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG07992-001.
               CALL 'ZAG07992' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG07992 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-002.
