      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN05109'.
      ...
      * Called module names
       01  MOD-ZEN07984              PIC X(8) VALUE 'ZEN07984'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN07984-001.
               PERFORM CALL-ZEN07984-002.
               PERFORM DERIVE-EXCESS-0001.
               PERFORM EXPAND-BEDROOMS-0002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN07984-001.
               CALL 'ZEN07984' USING DFHCOMMAREA
                         WS-STATUS-CODE.
