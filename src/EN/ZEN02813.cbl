      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN02813'.
      ...
      * Called module names
       ...
       01  MOD-ZEN06823              PIC X(8) VALUE 'ZEN06823'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN08043-001.
               PERFORM CALL-ZEN06823-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN06823-002.
               CALL 'ZEN06823' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN06823 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
