      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN02884'.
      ...
      * Called module names
       01  MOD-ZCU06386              PIC X(8) VALUE 'ZCU06386'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU06386-001.
               PERFORM CALL-ZEN06943-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU06386-001.
               CALL 'ZCU06386' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU06386 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN06943-002.
