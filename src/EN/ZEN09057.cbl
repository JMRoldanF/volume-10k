      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN09057'.
      ...
      * Called module names
       ...
       01  MOD-ZEN03063              PIC X(8) VALUE 'ZEN03063'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU06804-001.
               PERFORM CALL-ZEN07323-002.
               PERFORM CALL-ZMT08671-003.
               PERFORM CALL-ZEN07013-004.
               PERFORM CALL-ZEN03063-005.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU06804-001.
               MOVE 'ZCU06804' TO WS-SUBNAME-2
               CALL WS-SUBNAME-2 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU06804 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN07323-002.
               MOVE 'ZEN07323' TO WS-SUBNAME-3
      ...
      *----------------------------------------------------------------*
       CALL-ZEN03063-005.
               CALL 'ZEN03063' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN03063 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EXCESS-0001.
