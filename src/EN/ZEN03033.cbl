      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN03033'.
      ...
      * Called module names
       ...
       01  MOD-ZBI06696              PIC X(8) VALUE 'ZBI06696'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI06696-002.
               CALL 'ZBI06696' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI06696 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
