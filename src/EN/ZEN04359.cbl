      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN04359'.
      ...
      * Called module names
       01  MOD-ZEN07042              PIC X(8) VALUE 'ZEN07042'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN07042-001.
               CALL 'ZEN07042' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN07042 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
