      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN03794'.
      ...
      * Called module names
       ...
       01  MOD-ZEN06430              PIC X(8) VALUE 'ZEN06430'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN06430-002.
               CALL 'ZEN06430' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN06430 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-003.
