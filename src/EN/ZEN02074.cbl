      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN02074'.
      ...
      * Called module names
       01  MOD-ZEN03706              PIC X(8) VALUE 'ZEN03706'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN03706-001.
               EXEC CICS LINK PROGRAM('ZEN03706')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN03706 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-002.
