      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN03443'.
      ...
      * Called module names
       ...
       01  MOD-ZEN07673              PIC X(8) VALUE 'ZEN07673'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN07103-001.
               PERFORM CALL-ZEN07673-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN07673-002.
               CALL 'ZEN07673' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN07673 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EXCESS-0001.
