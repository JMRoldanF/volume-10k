      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN03963'.
      ...
      * Called module names
       01  MOD-ZEN06863              PIC X(8) VALUE 'ZEN06863'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN06863-002.
               CALL 'ZEN06863' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN06863 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-003.
