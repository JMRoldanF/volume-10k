      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN04493'.
      ...
      * Called module names
       ...
       01  MOD-ZEN07263              PIC X(8) VALUE 'ZEN07263'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN07263-002.
               CALL 'ZEN07263' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
