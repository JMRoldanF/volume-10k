      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01246'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG04393-001.
               PERFORM CALL-ZEN05310-003.
               PERFORM CALL-ZEN07037-004.
               PERFORM CALL-ZEN06448-005.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG04393-001.
               MOVE 'ZAG04393' TO WS-PROGNAME-8
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG04393 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN06021-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN05310-003.
               MOVE 'ZEN05310' TO WS-PROGNAME-1
