      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN04673'.
      ...
      * Called module names
       01  MOD-ZBI08466              PIC X(8) VALUE 'ZBI08466'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI08466-001.
               CALL 'ZBI08466' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI08466 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-002.
