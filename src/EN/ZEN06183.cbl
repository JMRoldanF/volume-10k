      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN06183'.
      ...
      * Called module names
       01  MOD-ZEN06783              PIC X(8) VALUE 'ZEN06783'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN06783-001.
               PERFORM CALL-ZUW07430-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN06783-001.
               CALL 'ZEN06783' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN06783 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW07430-002.
