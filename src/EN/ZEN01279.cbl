      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01279'.
      ...
      * Called module names
       01  MOD-ZEN04504              PIC X(8) VALUE 'ZEN04504'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN04504-001.
               EXEC CICS LINK PROGRAM('ZEN04504')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN04504 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-002.
