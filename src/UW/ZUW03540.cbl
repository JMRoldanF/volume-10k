      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW03540'.
      ...
      * Called module names
       01  MOD-ZUW07800              PIC X(8) VALUE 'ZUW07800'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW07800-001.
               CALL 'ZUW07800' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW07800 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-MAKE-0001.
