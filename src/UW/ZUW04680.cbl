      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW04680'.
      ...
      * Called module names
       ...
       01  MOD-ZUW07240              PIC X(8) VALUE 'ZUW07240'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW06980-001.
               PERFORM CALL-ZUW07240-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW07240-002.
               CALL 'ZUW07240' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW07240 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-003.
