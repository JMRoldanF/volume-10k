      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW05129'.
      ...
      * Called module names
       01  MOD-ZUW07564              PIC X(8) VALUE 'ZUW07564'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW07564-001.
               CALL 'ZUW07564' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW07564 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-TERM-0001.
