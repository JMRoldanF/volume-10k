      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW03410'.
      ...
      * Called module names
       01  MOD-ZMT08191              PIC X(8) VALUE 'ZMT08191'.
       01  MOD-ZMT08451              PIC X(8) VALUE 'ZMT08451'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT08191-001.
               PERFORM CALL-ZMT08451-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08191-001.
               CALL 'ZMT08191' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08191 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT08451-002.
               CALL 'ZMT08451' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08451 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
