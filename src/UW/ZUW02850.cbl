      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW02850'.
      ...
      * Called module names
       01  MOD-ZRE08177              PIC X(8) VALUE 'ZRE08177'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE08177-002.
               CALL 'ZRE08177' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE08177 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
