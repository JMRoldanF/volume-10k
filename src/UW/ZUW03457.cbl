      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW03457'.
      ...
      * Called module names
       01  MOD-ZUW07284              PIC X(8) VALUE 'ZUW07284'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW07284-001.
               CALL 'ZUW07284' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW07284 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-002.
