      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW04799'.
      ...
      * Called module names
       ...
       01  MOD-ZUW07334              PIC X(8) VALUE 'ZUW07334'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW07334-002.
               CALL 'ZUW07334' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW07334 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
