      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW02930'.
      ...
      * Called module names
       01  MOD-ZUW08360              PIC X(8) VALUE 'ZUW08360'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW08360-001.
               PERFORM CALL-ZUW06360-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW08360-001.
               CALL 'ZUW08360' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW08360 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW06360-002.
