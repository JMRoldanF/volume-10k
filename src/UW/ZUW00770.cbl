      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00770'.
      ...
      * Called module names
       01  MOD-ZCL02185              PIC X(8) VALUE 'ZCL02185'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL02185-001.
               EXEC CICS LINK PROGRAM('ZCL02185')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL02185 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01380-002.
