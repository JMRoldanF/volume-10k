      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW04150'.
      ...
      * Called module names
       01  MOD-ZUW07340              PIC X(8) VALUE 'ZUW07340'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW07340-001.
               CALL 'ZUW07340' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW07340 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW07130-002.
               MOVE 'ZUW07130' TO WS-SUBNAME-2
