      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW02927'.
      ...
      * Called module names
       01  MOD-ZUW08079              PIC X(8) VALUE 'ZUW08079'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW08079-001.
               CALL 'ZUW08079' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW08079 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-002.
