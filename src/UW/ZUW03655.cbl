      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW03655'.
      ...
      * Called module names
       ...
       01  MOD-ZEN06738              PIC X(8) VALUE 'ZEN06738'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW08302-001.
               PERFORM CALL-ZEN06738-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN06738-002.
               CALL 'ZEN06738' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
