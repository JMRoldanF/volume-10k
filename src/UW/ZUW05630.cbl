      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW05630'.
      ...
      * Called module names
       01  MOD-ZUW08050              PIC X(8) VALUE 'ZUW08050'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW08050-001.
               CALL 'ZUW08050' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW08050 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-002.
