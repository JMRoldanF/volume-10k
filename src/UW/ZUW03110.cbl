      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW03110'.
      ...
      * Called module names
       01  MOD-ZUW08160              PIC X(8) VALUE 'ZUW08160'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW08160-001.
               CALL 'ZUW08160' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW08160 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW06980-002.
