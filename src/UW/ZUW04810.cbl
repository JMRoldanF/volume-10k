      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW04810'.
      ...
      * Called module names
       01  MOD-ZUW08270              PIC X(8) VALUE 'ZUW08270'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW08270-001.
               CALL 'ZUW08270' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW08270 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW08460-002.
