      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW05732'.
      ...
      * Called module names
       ...
       01  MOD-ZUW08119              PIC X(8) VALUE 'ZUW08119'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW08119-002.
               CALL 'ZUW08119' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
