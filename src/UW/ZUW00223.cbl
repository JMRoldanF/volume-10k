      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00223'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW02158-001.
               PERFORM CALL-ZEN01382-002.
               PERFORM CALL-ZUW02144-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW02158-001.
               MOVE 'ZUW02158' TO WS-PROGNAME-3
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW02158 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01382-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW02144-003.
               MOVE 'ZUW02144' TO WS-PROGNAME-4
