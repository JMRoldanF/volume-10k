      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW04829'.
      ...
      * Called module names
       01  MOD-ZUW07051              PIC X(8) VALUE 'ZUW07051'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW07051-001.
               PERFORM CALL-ZUW06665-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW07051-001.
               CALL 'ZUW07051' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW07051 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW06665-002.
