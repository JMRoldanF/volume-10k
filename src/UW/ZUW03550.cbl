      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW03550'.
      ...
      * Called module names
       01  MOD-ZUW08490              PIC X(8) VALUE 'ZUW08490'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW08490-001.
               CALL 'ZUW08490' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW08490 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-002.
