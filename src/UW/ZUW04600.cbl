      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW04600'.
      ...
      * Called module names
       ...
       01  MOD-ZUW06430              PIC X(8) VALUE 'ZUW06430'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW07920-001.
               PERFORM CALL-ZUW06430-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW06430-002.
               CALL 'ZUW06430' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW06430 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-003.
