      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW02830'.
      ...
      * Called module names
       ...
       01  MOD-ZEN07043              PIC X(8) VALUE 'ZEN07043'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN07043-002.
               CALL 'ZEN07043' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN07043 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
