      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW03260'.
      ...
      * Called module names
       01  MOD-ZUW08420              PIC X(8) VALUE 'ZUW08420'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW08420-001.
               PERFORM CALL-ZUW07830-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW08420-001.
               CALL 'ZUW08420' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW08420 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW07830-002.
