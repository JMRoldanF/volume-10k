      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW04439'.
      ...
      * Called module names
       01  MOD-ZUW06983              PIC X(8) VALUE 'ZUW06983'.
       01  MOD-ZUW06931              PIC X(8) VALUE 'ZUW06931'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW06983-001.
               CALL 'ZUW06983' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW06983 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW06931-002.
               CALL 'ZUW06931' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW06931 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
