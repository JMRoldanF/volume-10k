      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW04440'.
      ...
      * Called module names
       ...
       01  MOD-ZUW08060              PIC X(8) VALUE 'ZUW08060'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW07300-001.
               PERFORM CALL-ZUW08060-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW08060-002.
               CALL 'ZUW08060' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW08060 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-003.
