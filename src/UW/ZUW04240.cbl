      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW04240'.
      ...
      * Called module names
       ...
       01  MOD-ZUW07060              PIC X(8) VALUE 'ZUW07060'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW07060-002.
               CALL 'ZUW07060' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW07060 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-003.
