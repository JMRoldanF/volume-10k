      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW04530'.
      ...
      * Called module names
       ...
       01  MOD-ZUW08570              PIC X(8) VALUE 'ZUW08570'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW08070-001.
               PERFORM CALL-ZUW08570-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW08570-002.
               CALL 'ZUW08570' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW08570 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
