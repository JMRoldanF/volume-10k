      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW03510'.
      ...
      * Called module names
       ...
       01  MOD-ZUW06650              PIC X(8) VALUE 'ZUW06650'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW06650-002.
               CALL 'ZUW06650' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW06650 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-003.
