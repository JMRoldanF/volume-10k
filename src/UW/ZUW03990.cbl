      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW03990'.
      ...
      * Called module names
       01  MOD-ZUW07270              PIC X(8) VALUE 'ZUW07270'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW07270-001.
               CALL 'ZUW07270' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW07270 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-002.
