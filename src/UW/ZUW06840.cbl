      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW06840'.
      ...
      * Called module names
       01  MOD-ZMT08621              PIC X(8) VALUE 'ZMT08621'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT08621-001.
               CALL 'ZMT08621' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT08621 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-002.
