      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA06002'.
      ...
      * Called module names
       01  MOD-ZPA08415              PIC X(8) VALUE 'ZPA08415'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA08415-001.
               CALL 'ZPA08415' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA08415 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-002.
