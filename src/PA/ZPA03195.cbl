      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA03195'.
      ...
      * Called module names
       01  MOD-ZPA06595              PIC X(8) VALUE 'ZPA06595'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA06595-001.
               CALL 'ZPA06595' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA06595 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA08349-002.
