      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA05199'.
      ...
      * Called module names
       01  MOD-ZPA08499              PIC X(8) VALUE 'ZPA08499'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA08499-001.
               CALL 'ZPA08499' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA08499 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-002.
