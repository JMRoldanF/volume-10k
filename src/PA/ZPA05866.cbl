      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA05866'.
      ...
      * Called module names
       01  MOD-ZAG06377              PIC X(8) VALUE 'ZAG06377'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG06377-001.
               CALL 'ZAG06377' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG06377 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA06795-002.
