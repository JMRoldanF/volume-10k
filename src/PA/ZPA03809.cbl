      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA03809'.
      ...
      * Called module names
       ...
       01  MOD-ZPA07189              PIC X(8) VALUE 'ZPA07189'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA07189-002.
               CALL 'ZPA07189' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA07189 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-003.
