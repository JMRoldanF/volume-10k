      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA03780'.
      ...
      * Called module names
       ...
       01  MOD-ZPA08634              PIC X(8) VALUE 'ZPA08634'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA08218-001.
               PERFORM CALL-ZPA08634-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA08634-002.
               CALL 'ZPA08634' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA08634 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-003.
