      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA04879'.
      ...
      * Called module names
       ...
       01  MOD-ZPA07059              PIC X(8) VALUE 'ZPA07059'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA07059-002.
               CALL 'ZPA07059' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA07059 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-003.
