      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA05159'.
      ...
      * Called module names
       01  MOD-ZPA07269              PIC X(8) VALUE 'ZPA07269'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA07269-001.
               CALL 'ZPA07269' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA07269 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT08421-002.
