      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA04993'.
      ...
      * Called module names
       01  MOD-ZMT06426              PIC X(8) VALUE 'ZMT06426'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT06426-001.
               CALL 'ZMT06426' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT06426 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA07663-002.
