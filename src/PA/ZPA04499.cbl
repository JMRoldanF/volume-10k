      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA04499'.
      ...
      * Called module names
       01  MOD-ZPA08039              PIC X(8) VALUE 'ZPA08039'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA08039-001.
               CALL 'ZPA08039' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA08039 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA07169-002.
