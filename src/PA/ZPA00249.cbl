      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00249'.
      ...
      * Called module names
       01  MOD-ZPA00989              PIC X(8) VALUE 'ZPA00989'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00989-001.
               PERFORM CALL-ZPA01189-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00989-001.
               EXEC CICS LINK PROGRAM('ZPA00989')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00989 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01189-002.
