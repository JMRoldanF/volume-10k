      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA03539'.
      ...
      * Called module names
       01  MOD-ZPA06339              PIC X(8) VALUE 'ZPA06339'.
       01  MOD-ZPA06909              PIC X(8) VALUE 'ZPA06909'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA06339-001.
               PERFORM CALL-ZPA06909-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA06339-001.
               CALL 'ZPA06339' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA06339 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA06909-002.
               CALL 'ZPA06909' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA06909 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-003.
