      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA04537'.
      ...
      * Called module names
       01  MOD-ZPA07521              PIC X(8) VALUE 'ZPA07521'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA07521-001.
               PERFORM CALL-ZAG07458-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA07521-001.
               CALL 'ZPA07521' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA07521 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG07458-002.
