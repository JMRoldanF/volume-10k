      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA02129'.
      ...
      * Called module names
       01  MOD-ZPA03989              PIC X(8) VALUE 'ZPA03989'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA03989-001.
               EXEC CICS LINK PROGRAM('ZPA03989')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA03989 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-002.
