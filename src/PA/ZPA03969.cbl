      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA03969'.
      ...
      * Called module names
       ...
       01  MOD-ZPA07079              PIC X(8) VALUE 'ZPA07079'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU06314-001.
               PERFORM CALL-ZPA07079-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA07079-002.
               CALL 'ZPA07079' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA07079 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-003.
