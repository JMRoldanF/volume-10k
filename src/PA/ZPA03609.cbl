      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA03609'.
      ...
      * Called module names
       01  MOD-ZPA07229              PIC X(8) VALUE 'ZPA07229'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA07229-001.
               PERFORM CALL-ZPA08249-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA07229-001.
               CALL 'ZPA07229' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA07229 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA08249-002.
