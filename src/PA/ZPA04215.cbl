      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA04215'.
      ...
      * Called module names
       01  MOD-ZPA06795              PIC X(8) VALUE 'ZPA06795'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA06795-001.
               CALL 'ZPA06795' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA06795 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA06359-002.
