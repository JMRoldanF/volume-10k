      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00209'.
      ...
      * Called module names
       01  MOD-ZCL01875              PIC X(8) VALUE 'ZCL01875'.
       01  MOD-ZPA02439              PIC X(8) VALUE 'ZPA02439'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01875-001.
               PERFORM CALL-ZPA02439-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01875-001.
               EXEC CICS LINK PROGRAM('ZCL01875')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01875 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA02439-002.
               EXEC CICS LINK PROGRAM('ZPA02439')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA02439 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-003.
