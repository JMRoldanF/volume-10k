      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA03349'.
      ...
      * Called module names
       01  MOD-ZPA07519              PIC X(8) VALUE 'ZPA07519'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA07519-001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPA07519-001.
               CALL 'ZPA07519' USING DFHCOMMAREA
                         WS-STATUS-CODE.
