      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA03939'.
      ...
      * Called module names
       ...
       01  MOD-ZPA08449              PIC X(8) VALUE 'ZPA08449'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA06719-001.
               PERFORM CALL-ZPA08449-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA08449-002.
               CALL 'ZPA08449' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
