      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA02799'.
      ...
      * Called module names
       01  MOD-ZCU03274              PIC X(8) VALUE 'ZCU03274'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA04989-001.
               MOVE 'ZPA04989' TO WS-PROGNAME-8
      ...
      *----------------------------------------------------------------*
       CALL-ZCU03274-002.
               EXEC CICS LINK PROGRAM('ZCU03274')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU03274 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TERM-0001.
