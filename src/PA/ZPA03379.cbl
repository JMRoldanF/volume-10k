      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA03379'.
      ...
      * Called module names
       ...
       01  MOD-ZPA07589              PIC X(8) VALUE 'ZPA07589'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA06579-001.
               PERFORM CALL-ZPA07589-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA07589-002.
               CALL 'ZPA07589' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA07589 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-003.
