      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA04599'.
      ...
      * Called module names
       ...
       01  MOD-ZPA07809              PIC X(8) VALUE 'ZPA07809'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA07809-002.
               CALL 'ZPA07809' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
