      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA05189'.
      ...
      * Called module names
       01  MOD-ZPA07749              PIC X(8) VALUE 'ZPA07749'.
       01  MOD-ZPA06769              PIC X(8) VALUE 'ZPA06769'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA07749-001.
               PERFORM CALL-ZPA06769-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA07749-001.
               CALL 'ZPA07749' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA07749 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA06769-002.
               CALL 'ZPA06769' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
