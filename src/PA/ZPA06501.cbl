      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA06501'.
      ...
      * Called module names
       ...
       01  MOD-ZPA07937              PIC X(8) VALUE 'ZPA07937'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA07937-002.
               CALL 'ZPA07937' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA07937 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-003.
