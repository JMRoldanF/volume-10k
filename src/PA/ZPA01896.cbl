      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01896'.
      ...
      * Called module names
       ...
       01  MOD-ZPA07254              PIC X(8) VALUE 'ZPA07254'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA03584-001.
               PERFORM CALL-ZPA06685-002.
               PERFORM CALL-ZPA07254-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA07254-003.
               CALL 'ZPA07254' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA07254 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-004.
