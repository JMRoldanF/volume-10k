      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA04099'.
      ...
      * Called module names
       01  MOD-ZPA08559              PIC X(8) VALUE 'ZPA08559'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA08559-001.
               CALL 'ZPA08559' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA08559 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
