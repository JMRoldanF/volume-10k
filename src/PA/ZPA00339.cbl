      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00339'.
      ...
      * Called module names
       ...
       01  MOD-ZPA02305              PIC X(8) VALUE 'ZPA02305'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA02305-002.
               EXEC CICS LINK PROGRAM('ZPA02305')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA02305 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01191-003.
