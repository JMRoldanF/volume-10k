      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA04719'.
      ...
      * Called module names
       01  MOD-ZPA07439              PIC X(8) VALUE 'ZPA07439'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA07439-001.
               CALL 'ZPA07439' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA07439 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA06719-002.
               MOVE 'ZPA06719' TO WS-SUBNAME-3
