      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA05355'.
      ...
      * Called module names
       01  MOD-ZPA07587              PIC X(8) VALUE 'ZPA07587'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA07587-001.
               CALL 'ZPA07587' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA07587 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-002.
