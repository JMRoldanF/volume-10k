      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA03297'.
      ...
      * Called module names
       01  MOD-ZPA07304              PIC X(8) VALUE 'ZPA07304'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA07304-001.
               PERFORM CALL-ZMT07797-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA07304-001.
               CALL 'ZPA07304' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA07304 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT07797-002.
