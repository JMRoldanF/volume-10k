      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA02969'.
      ...
      * Called module names
       01  MOD-ZPA08569              PIC X(8) VALUE 'ZPA08569'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA08569-001.
               CALL 'ZPA08569' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA08569 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-002.
