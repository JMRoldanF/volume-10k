      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA04019'.
      ...
      * Called module names
       01  MOD-ZPA06959              PIC X(8) VALUE 'ZPA06959'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA06959-001.
               CALL 'ZPA06959' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA06959 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL08595-002.
