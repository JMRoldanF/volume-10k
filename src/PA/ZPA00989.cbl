      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00989'.
      ...
      * Called module names
       01  MOD-ZUW04350              PIC X(8) VALUE 'ZUW04350'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW04350-001.
               EXEC CICS LINK PROGRAM('ZUW04350')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW04350 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE06807-002.
