      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE04076'.
      ...
      * Called module names
       ...
       01  MOD-ZRE06759              PIC X(8) VALUE 'ZRE06759'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE07236-001.
               PERFORM CALL-ZRE06759-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE06759-002.
               CALL 'ZRE06759' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE06759 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EQUITIES-0001.
