      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01217'.
      ...
      * Called module names
       01  MOD-ZRE03447              PIC X(8) VALUE 'ZRE03447'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE03447-001.
               EXEC CICS LINK PROGRAM('ZRE03447')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE03447 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO09996-002.
