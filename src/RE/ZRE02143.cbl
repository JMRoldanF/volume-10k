      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE02143'.
      ...
      * Called module names
       ...
       01  MOD-ZCU05660              PIC X(8) VALUE 'ZCU05660'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE05108-002.
               PERFORM CALL-ZCU05660-003.
               PERFORM CALL-ZBI06791-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU05660-003.
               EXEC CICS LINK PROGRAM('ZCU05660')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU05660 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI06791-004.
