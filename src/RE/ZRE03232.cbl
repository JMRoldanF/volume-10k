      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE03232'.
      ...
      * Called module names
       ...
       01  MOD-ZRE07578              PIC X(8) VALUE 'ZRE07578'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE07578-002.
               CALL 'ZRE07578' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
