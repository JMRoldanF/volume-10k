      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE03927'.
      ...
      * Called module names
       ...
       01  MOD-ZRE06907              PIC X(8) VALUE 'ZRE06907'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE06907-002.
               CALL 'ZRE06907' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE06907 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
