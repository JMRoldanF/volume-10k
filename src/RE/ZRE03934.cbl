      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE03934'.
      ...
      * Called module names
       ...
       01  MOD-ZRE07618              PIC X(8) VALUE 'ZRE07618'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE07618-002.
               CALL 'ZRE07618' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE07618 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-003.
