      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE02984'.
      ...
      * Called module names
       01  MOD-ZRE06562              PIC X(8) VALUE 'ZRE06562'.
       01  MOD-ZHO06549              PIC X(8) VALUE 'ZHO06549'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE06562-001.
               PERFORM CALL-ZHO06549-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE06562-001.
               CALL 'ZRE06562' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO06549-002.
               CALL 'ZHO06549' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO06549 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-003.
