      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00736'.
      ...
      * Called module names
       01  MOD-ZRE00836              PIC X(8) VALUE 'ZRE00836'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00836-001.
               PERFORM CALL-ZRE01504-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00836-001.
               EXEC CICS LINK PROGRAM('ZRE00836')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00836 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01504-002.
               MOVE 'ZRE01504' TO WS-PROGNAME-1
