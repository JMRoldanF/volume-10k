      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00837'.
      ...
      * Called module names
       ...
       01  MOD-ZRE03407              PIC X(8) VALUE 'ZRE03407'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE03407-002.
               PERFORM CALL-ZRE04187-003.
               PERFORM CALL-ZRE05167-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE03407-002.
               EXEC CICS LINK PROGRAM('ZRE03407')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE03407 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE04187-003.
               MOVE 'ZRE04187' TO WS-PROGNAME-7
      ...
      *----------------------------------------------------------------*
       CALL-ZRE05167-004.
               MOVE 'ZRE05167' TO WS-PROGNAME-8
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE05167 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-005.
