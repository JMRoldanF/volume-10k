      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE03954'.
      ...
      * Called module names
       ...
       01  MOD-ZRE06403              PIC X(8) VALUE 'ZRE06403'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE08652-001.
               PERFORM CALL-ZRE06403-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE06403-002.
               CALL 'ZRE06403' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
