      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01207'.
      ...
      * Called module names
       01  MOD-ZRE03437              PIC X(8) VALUE 'ZRE03437'.
       01  MOD-ZRE04527              PIC X(8) VALUE 'ZRE04527'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE03437-001.
               PERFORM CALL-ZRE04527-002.
               PERFORM CALL-ZRE05727-003.
               PERFORM CALL-ZEN05303-004.
               PERFORM CALL-ZRE08327-005.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE03437-001.
               EXEC CICS LINK PROGRAM('ZRE03437')
      ...
      *----------------------------------------------------------------*
       CALL-ZRE04527-002.
               EXEC CICS LINK PROGRAM('ZRE04527')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE04527 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE05727-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN05303-004.
               MOVE 'ZEN05303' TO WS-PROGNAME-5
