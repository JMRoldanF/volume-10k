      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE03807'.
      ...
      * Called module names
       01  MOD-ZRE06607              PIC X(8) VALUE 'ZRE06607'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE06607-001.
               CALL 'ZRE06607' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE06607 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE08197-002.
