      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE02997'.
      ...
      * Called module names
       ...
       01  MOD-ZRE06387              PIC X(8) VALUE 'ZRE06387'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE06387-002.
               CALL 'ZRE06387' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
