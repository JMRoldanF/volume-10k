      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE04435'.
      ...
      * Called module names
       01  MOD-ZRE07983              PIC X(8) VALUE 'ZRE07983'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE07983-001.
               CALL 'ZRE07983' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE07983 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
