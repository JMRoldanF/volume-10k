      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE05097'.
      ...
      * Called module names
       ...
       01  MOD-ZRE08437              PIC X(8) VALUE 'ZRE08437'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE08247-001.
               PERFORM CALL-ZRE08437-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE08437-002.
               CALL 'ZRE08437' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE08437 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-003.
