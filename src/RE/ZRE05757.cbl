      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE05757'.
      ...
      * Called module names
       01  MOD-ZRE08577              PIC X(8) VALUE 'ZRE08577'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE07637-001.
               PERFORM CALL-ZRE08577-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE08577-002.
               CALL 'ZRE08577' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE08577 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-003.
