      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE04208'.
      ...
      * Called module names
       ...
       01  MOD-ZRE07860              PIC X(8) VALUE 'ZRE07860'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE06813-001.
               PERFORM CALL-ZRE07860-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE07860-002.
               CALL 'ZRE07860' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE07860 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU09998-003.
