      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE02917'.
      ...
      * Called module names
       ...
       01  MOD-ZRE08217              PIC X(8) VALUE 'ZRE08217'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE08217-002.
               CALL 'ZRE08217' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
