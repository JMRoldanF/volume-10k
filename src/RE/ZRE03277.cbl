      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE03277'.
      ...
      * Called module names
       01  MOD-ZRE07237              PIC X(8) VALUE 'ZRE07237'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE07237-001.
               PERFORM CALL-ZRE07547-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE07237-001.
               CALL 'ZRE07237' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE07237 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE07547-002.
               MOVE 'ZRE07547' TO WS-SUBNAME-2
