      ...
      * Called module names
       01  MOD-ZRE01157              PIC X(8) VALUE 'ZRE01157'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01157-001.
               PERFORM CALL-ZRE01867-002.
               PERFORM CALL-ZCL00655-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01157-001.
               EXEC CICS LINK PROGRAM('ZRE01157')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01157 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01867-002.
               MOVE 'ZRE01867' TO WS-PROGNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00655-003.
               EXEC CICS START TRANSID('Z0I7')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z0I7 is defined against ZCL00655
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00655 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
