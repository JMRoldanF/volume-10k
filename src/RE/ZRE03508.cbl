      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE03508'.
      ...
      * Called module names
       01  MOD-ZRE06396              PIC X(8) VALUE 'ZRE06396'.
       01  MOD-ZRE06599              PIC X(8) VALUE 'ZRE06599'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE06396-001.
               CALL 'ZRE06396' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE06599-002.
               CALL 'ZRE06599' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE06599 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT09995-003.
