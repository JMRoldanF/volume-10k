      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE04426'.
      ...
      * Called module names
       ...
       01  MOD-ZRE08455              PIC X(8) VALUE 'ZRE08455'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE08397-001.
               PERFORM CALL-ZRE08455-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE08455-002.
               CALL 'ZRE08455' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE08455 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
