      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE02237'.
      ...
      * Called module names
       ...
       01  MOD-ZHO08652              PIC X(8) VALUE 'ZHO08652'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE02817-002.
               PERFORM CALL-ZHO06622-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE02817-002.
               MOVE 'ZRE02817' TO WS-PROGNAME-7
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE02817 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO06622-003.
               MOVE 'ZHO06622' TO WS-SUBNAME-8
      ...
      *----------------------------------------------------------------*
       CALL-ZHO08652-004.
               CALL 'ZHO08652' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
