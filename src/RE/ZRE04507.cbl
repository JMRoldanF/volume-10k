      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE04507'.
      ...
      * Called module names
       01  MOD-ZBI08646              PIC X(8) VALUE 'ZBI08646'.
       01  MOD-ZRE06867              PIC X(8) VALUE 'ZRE06867'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI08646-001.
               PERFORM CALL-ZRE06867-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI08646-001.
               CALL 'ZBI08646' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI08646 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE06867-002.
               CALL 'ZRE06867' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE06867 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-003.
