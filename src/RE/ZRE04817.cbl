      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE04817'.
      ...
      * Called module names
       01  MOD-ZRE08187              PIC X(8) VALUE 'ZRE08187'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE08187-001.
               PERFORM CALL-ZRE07827-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE08187-001.
               CALL 'ZRE08187' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE08187 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE07827-002.
