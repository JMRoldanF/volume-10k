      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE04757'.
      ...
      * Called module names
       ...
       01  MOD-ZRE07507              PIC X(8) VALUE 'ZRE07507'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE07647-001.
               PERFORM CALL-ZRE07507-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE07507-002.
               CALL 'ZRE07507' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE07507 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL09999-003.
