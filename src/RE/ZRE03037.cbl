      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE03037'.
      ...
      * Called module names
       01  MOD-ZRE07147              PIC X(8) VALUE 'ZRE07147'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE07147-001.
               CALL 'ZRE07147' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE07147 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN09997-002.
