      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE05377'.
      ...
      * Called module names
       ...
       01  MOD-ZRE08007              PIC X(8) VALUE 'ZRE08007'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE08007-002.
               CALL 'ZRE08007' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE08007 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-TAX-BAND-0001.
