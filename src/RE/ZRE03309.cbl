      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE03309'.
      ...
      * Called module names
       01  MOD-ZHO06393              PIC X(8) VALUE 'ZHO06393'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO06393-001.
               PERFORM CALL-ZRE07602-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO06393-001.
               CALL 'ZHO06393' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO06393 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE07602-002.
