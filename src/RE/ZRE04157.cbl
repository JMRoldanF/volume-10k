      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE04157'.
      ...
      * Called module names
       ...
       01  MOD-ZRE08667              PIC X(8) VALUE 'ZRE08667'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA06319-001.
               PERFORM CALL-ZRE08667-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE08667-002.
               CALL 'ZRE08667' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE08667 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI10000-003.
